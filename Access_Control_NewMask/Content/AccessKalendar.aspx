<%@ Page Title="<%$ Resources:localizedText, accessCalendar %>" Language="C#" MasterPageFile="~/MasterPages/Secondary.Master" AutoEventWireup="true" CodeBehind="AccessKalendar.aspx.cs" Inherits="Access_Control_NewMask.Content.AccessKalendar" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/AccessKalendar.js"></script>
    <link href="Styles/AccessKalendar.css" rel="stylesheet" />
    <link href="Styles/FormViewSearch.css" rel="stylesheet" />
    <%-- <link href="Styles/ImportantInfoDialogAcckal.css" rel="stylesheet" />--%>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <asp:HiddenField ID="hiddenFieldPassed" runat="server" />
...
dplCalendarNrEndCallBack(s,e);	
                                ...
                                <Columns>
                                    <dx:ListBoxColumn FieldName="Calendar_Nr" Caption="<%$ Resources:localizedText, no2 %>" Width="20%" />
                                    <dx:ListBoxColumn FieldName="Calendar_Name" Caption="<%$ Resources:localizedText, descriptionAccs %>" Width="80%" />
                                </Columns>
                            </dx:ASPxComboBox>
                        ...
                        <section class="secdivisionNew">
                            ...
                            <dx:ASPxComboBox ID="dplCalendarName" runat="server" CssClass="ddlistBesch" TextField="Calendar_Name" ValueField="ID" EnableCallbackMode="true" OnCallback="dplCalendarName_Callback" Theme="Office2003Blue" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" TextFormatString="{1}" DropDownRows="20" DropDownWidth="400px">
                                <ClientSideEvents SelectedIndexChanged="function(s, e) {
calendarSelectedChanged(s,e);
}"
                                    DropDown="function(s, e) {
DropDownClick(s,e);	
	...
	dplCalendarNameEndCallBack(s,e);
                    ...
                    <section class="rightTopContentAreaDiv">
                        <section class="secSearch">
                            ...
                            <asp:Button ID="btnSearchAllEmp" runat="server" Text="" CssClass="searchfltrighte btnsrch" BorderStyle="None" Width="24px" Height="24px" BackColor="White" Style="border-radius: 5px; margin-top: 8px;" />
                        </section>
        ...
        <div id="accessGroupDiv" class="bottomsectiondiv">
            <section class="bottomsectiondivNew">
                <asp:Label ID="Label29" runat="server" Text="<%$ Resources:localizedText, accessCalendar1 %>" CssClass="lblHeader2"></asp:Label>
                <section class="bottomsectiondivleft1aTop">
                    <section class="table">
                        <dx:ASPxGridView ID="grdAccessCalendar" ClientInstanceName="grdAccessCalendar" runat="server" AutoGenerateColumns="False" Theme="Office2003Blue" Width="100%" KeyFieldName="ID" OnHtmlDataCellPrepared="grdAccessCalendar_HtmlDataCellPrepared" OnCustomCallback="grdAccessCalendar_CustomCallback" EnableCallBacks="true">
                            <Columns>
                ...
                <section class="bottomsectiondivrightbBottom">
                    <section class="bottomsectiondivrightbBottomleft">
                        <asp:Label ID="Label8" runat="server" Text="<%$ Resources:localizedText, Profileselection1 %>" CssClass="profillbl" Style="height: 29px;"></asp:Label>
                        <section id="sectionAccessProfile" class="bottomlblleft">
                            <section class="topContHolder">
                                ...
                                <dx:ASPxComboBox ID="dplAccessProfileNr" runat="server" CssClass="ddlProfil2" ValueField="ID" TextField="AccessDescription"
                                    DropDownRows="20" DropDownWidth="600px" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" TextFormatString="{2}"
	...
	SetProfileSelectedDxDrp(s.GetValue());
                                    ...
                                    <Columns>
                                        ...
                                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, profileIdTitle %>" FieldName="AccessProfileID" Name="AccessProfileID" ToolTip="<%$ Resources:localizedText, profileIdTitle %>" Width="16%" />
                                    </Columns>
                                </dx:ASPxComboBox>
	...
	SetProfileSelectedDxDrp(s.GetValue());	
                                ...
                                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:localizedText, profileIdTitle %>" CssClass="lblZuchnew1"></asp:Label>
	...
	SetProfileSelectedDxDrp(s.GetValue());	
                                    ...
                                    <Columns>
                                        ...
                                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, profileNo %>" FieldName="AccessProfileNo" Name="AccessProfileNo" ToolTip="<%$ Resources:localizedText, profileNo %>" Width="15%" />
                                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, profileDescription %>" FieldName="AccessDescription" Name="AccessDescription" ToolTip="<%$ Resources:localizedText, profileDescription %>" Width="36%" />
                                        <dx:ListBoxColumn Caption="Profil ID:" FieldName="AccessProfileID" Name="AccessProfileID" ToolTip="<%$ Resources:localizedText, profileIdTitle %>" Width="16%" />
                                    </Columns>
                                </dx:ASPxComboBox>
                    ...
                    <section class="bottomsectiondivrightbBottomright">
                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:localizedText, Integratedprofile1 %>" CssClass="profillbl" Style="margin-left: 8px; height: 25px;"></asp:Label>
                        ...
                        <section class="bottomlbl">
                            ...
                            <div class="intergrated2">
                                <section id="sectionWeekButtons" class="bottom">
                                    ...
                                    <asp:Button ID="btnmonFri" runat="server" Text="<%$ Resources:localizedText, mondaytofriday %>" CssClass="button1 btnmonFri" />
                                    <asp:Button ID="btnSattoSun" runat="server" Text="<%$ Resources:localizedText, saturdaytosunday %>" CssClass="button2 btnSattoSun" />
                                </section>
                                <section class="rightbottom3">
                                    <div class="intergrated3">
                                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:localizedText, validprofil1 %>" CssClass="profillbl2"></asp:Label>
                                        <section class="rightDivs2">
                                            ...
                                            <section class="last">
                                                <section class="griddatemover" style="border: none;">
                                                    ...
                                                    <section class="griddatemovercenter" style="width: 95%;">
                                                        <dx:ASPxDateEdit ID="datePickerDateFrom" HorizontalAlign="Center" ClientInstanceName="datePickerDateFrom" Theme="Office2003Blue" runat="server" CssClass="ddlYearStyle2" Style="border-radius: 5px; height: 25px;">
                                        ...
                                        <section class="rightDivs1">
                                            ...
                                            <section class="center">
                                                <section class="griddatemover" style="border: none;">
                                                    ...
                                                    <section class="griddatemovercenter" style="width: 95%;">
                                                        <dx:ASPxDateEdit ID="datePickerDateTo" HorizontalAlign="Center" ClientInstanceName="datePickerDateTo" Theme="Office2003Blue" runat="server" CssClass="ddlYearStyle2" Style="border-radius: 5px; height: 25px;">
                                    ...
                                    <div class="intergrated4">
                                        <asp:Button ID="btnApply" runat="server" Text="<%$ Resources:localizedText, takeover %>" CssClass="applybtnfooterorange" />
                                    </div>
                                </section>
                            </div>
                        </section>
	...
	grdHolidayCalndrSingleClick(s,e)
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Width="3%" Caption="<%$ Resources:localizedText, calendarNoTtl %>" VisibleIndex="1" FieldName="Calendar_Nr">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Width="12%" Caption="<%$ Resources:localizedText, descriptionnew %>" VisibleIndex="2" FieldName="Calendar_Name"></dx:GridViewDataTextColumn>
                        </Columns>
                        <SettingsPager PageSize="20" ShowEmptyDataRows="true" Visible="False"></SettingsPager>
                ...
                <section class="secFooter">
                    <asp:Button ID="btnApplySelectedCalender" ClientIDMode="Static" runat="server" Text="<%$ Resources:localizedText, takeover %>" CssClass="applybtnfooterorange" Style="text-align: right !important; float: right; margin-top: 0;" />
                </section>
            </div>

        </div>
        <div id="searchAccessProfile" class="accssProfls" style="display: none; clear:both; height: 71%;">
            <div style="overflow-y:auto; float:left; height:96%; width:100%;">
	...
	gridViewAccessProfileRowClick(s,e);
            ...
            <asp:Button ID="btnApplyAccessProfile" runat="server" Text="<%$ Resources:localizedText, takeover %>" CssClass="applybtnAccessPlan"   Style="text-align: right !important;"/>
        </div>

    </div>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    <asp:Button ID="btnNew" CssClass="newbtnfooterblue" runat="server" Text="<%$ Resources:localizedText, accesscalendernew %>" Style="width: 134px !important;" OnClick="btnNew_Click" />
