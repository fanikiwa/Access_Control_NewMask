<%@ Page Title="Zutrittsplan - Zutrittskalender" Language="C#" MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="AccessPlanAccessCalender.aspx.cs" Inherits="Access_Control_NewMask.Content.AccessPlanAccessCalender" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/AccessPlanAccessCalender.js"></script>
    <link href="Styles/AccessPlanAccessCalender.css" rel="stylesheet" />
    <link href="Styles/FormViewSearch.css" rel="stylesheet" />
    <link href="Styles/AccessPlanAccessCalendar2.css" rel="stylesheet" />
</asp:Content>
        ...
        <div class="topsectiondiv">
               <section class="leftDvnsnewab">
                   <div class="ControlSecarea2" style="display: none;">
                        <asp:Label runat="server" Text=" <%$ Resources:localizedText, accessPlanGroupNo %>" CssClass="planGruppen1newabc"></asp:Label>
                        ...
                        <asp:Label runat="server" Text="<%$ Resources:localizedText, groupName %>" CssClass="planGruppen3newabcd"></asp:Label>
                        <asp:DropDownList ID="ddlAccessGroupName" ClientIDMode="Static" runat="server" DataValueField="Id" DataTextField="AccessGroupName" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" CssClass="planGruppen4newabcd"></asp:DropDownList>
                        <asp:Label runat="server" Text="<%$ Resources:localizedText, accessPlanNo %>" CssClass="planGruppen5newabcd"></asp:Label>
                        <asp:DropDownList ID="ddlAccessProfileNumber" ClientIDMode="Static" runat="server" DataValueField="ID" DataTextField="AccessPlanNr" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" CssClass="planGruppen6newabcd"></asp:DropDownList>
                        <asp:Label runat="server" Text="<%$ Resources:localizedText, description1 %>" CssClass="planGruppen7"></asp:Label>
                        <asp:DropDownList ID="ddlAccessProfileName" ClientIDMode="Static" runat="server" DataValueField="ID" DataTextField="AccessPlanDescription" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" CssClass="planGruppen8newabcd"></asp:DropDownList>
                        <asp:Button ID="Search" runat="server" Text="" CssClass="searchzutarea" />

                    </div>
                            <asp:Label runat="server" Text=" <%$ Resources:localizedText,  accessplangroupinfo %>" CssClass="Gruppen1newabc"></asp:Label>
                            <asp:TextBox ID="txtAccessGroupNumber" Enabled="false" ClientIDMode="Static" runat="server" CssClass="Gruppen2"></asp:TextBox>
                            <asp:Label runat="server" Text="<%$ Resources:localizedText, groupName %>" CssClass="Gruppen3newabcd"></asp:Label>
                            <asp:TextBox ID="txtAccessGroupName" Enabled="false" ClientIDMode="Static" runat="server" CssClass="Gruppen4newabcd"></asp:TextBox>
                            <asp:Label runat="server" Text="<%$ Resources:localizedText,  accessplannumber %>" CssClass="planGruppenfnew"></asp:Label>
                            <asp:TextBox ID="txtAccessProfileNumber" Enabled="false" ClientIDMode="Static" runat="server" CssClass="Gruppenfnew"></asp:TextBox>
                            <asp:Label runat="server" Text=" <%$ Resources:localizedText, description_new %>" CssClass="planGruppengtext"></asp:Label>
                            <asp:TextBox ID="txtAccessProfileName" Enabled="false" ClientIDMode="Static" runat="server" CssClass="Gruppengcalendernew"></asp:TextBox>
                        </section>
                        <section class="rightDvnsnewab">
                            <asp:Button ID="btnPersonnel" runat="server" Text="<%$ Resources:localizedText, people %>" CssClass="newstandardbutton Personenbutton2newabcd" PostBackUrl="~/Content/AccessPlanPersonal.aspx"></asp:Button>
				            ...
				            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
                            <asp:Button ID="btnReader" runat="server" Text="<%$ Resources:localizedText, reader %>" CssClass="newstandardbutton Leserbutton1newabcd" PostBackUrl="~/Content/AccessPlanReader.aspx"></asp:Button>
                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
                            <asp:Button ID="btnAccessProfile" runat="server" Text="<%$ Resources:localizedText, accessCalendar%>" Enabled="false" CssClass="newstandardbutton Zutrittsprofilbutton2newabcd"></asp:Button>
                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
                            <asp:Button ID="Button1" runat="server" Text="<%$ Resources:localizedText, holidaySchedule%>" Enabled="true" CssClass="newstandardbutton Zutrittsprofilbutton2textnewabcd" PostBackUrl="~/Content/AccessPlanHolidaySchedule.aspx"></asp:Button>
        ...
        <div id="accessGroupDiv" class="bottomsectiondiv">
            ...
            <section class="topdiv">
                <section class="topdivtop">
                    <section class="leftTopContentAreaDiv" style="margin-top: 8px;">
                   <%--      <section class="leftTopContentAreaDiv2">--%>
                        <section class="secdivision">
                            <asp:Label ID="lblZusch2" runat="server" CssClass="lblZuch" Text="<%$ Resources:localizedText, accessCalender %>"></asp:Label>
                            <asp:TextBox ID="txtCalendarNr" runat="server" CssClass="txtZusch"></asp:TextBox>
                        </section>
                        <section class="secdivisionNew2">
                 ...
                 <%--   </section>--%>
                        <section class="secdivision">
                            <asp:Label ID="lblZusch" runat="server" CssClass="lblZuch" Text="<%$ Resources:localizedText, accessCalender %>"></asp:Label>
                            
                             <dx:ASPxComboBox ID="dplCalendarNr" runat="server" CssClass="ddlistZusch" TextField="Calendar_Nr" ValueField="ID" EnableCallbackMode="true" OnCallback="dplCalendarNr_Callback"  Theme="Office2003Blue" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" TextFormatString="{0}" DropDownRows="20" DropDownWidth="400px">
...
DropDownClick(s,e);	
	...
	dplCalendarNameEndCallBack(s,e);
                        ...
                        <section class="secdivisionNew">
                            ...
                            <dx:ASPxComboBox ID="dplCalendarName" runat="server" CssClass="ddlistBesch" TextField="Calendar_Name" ValueField="ID" OnCallback="dplCalendarName_Callback" EnableCallbackMode="true"  Theme="Office2003Blue" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" TextFormatString="{1}" DropDownRows="20" DropDownWidth="400px">
                                <ClientSideEvents SelectedIndexChanged="function(s, e) {
calendarSelectedChanged(s,e);
}"
                                    DropDown="function(s, e) {
                    ...
                    <section class="rightTopContentAreaDiv">
                        ...
                        <section class="griddatemover2">
                            ...
                            <section class="griddatemovercenter2">
                                ...
                                <dx:ASPxComboBox runat="server" ID="ddlCalendarYear2" ClientIDMode="Static" Theme="Office2003Blue" ValueType="System.String" CssClass="ddlYearStyle2" Style="min-width: 100%;" HorizontalAlign="Center"></dx:ASPxComboBox>
                            </section>
          ...
          <%--      <section class="topdivbtm" >
            ...
            <section class="bottomsectiondivNew">
                ...
                <section class="bottomsectiondivleft1aTop">
                    <section class="table">
                        <dx:ASPxGridView ID="grdAccessCalendar" ClientInstanceName="grdAccessCalendar" OnHtmlDataCellPrepared="grdAccessCalendar_HtmlDataCellPrepared" OnCustomCallback="grdAccessCalendar_CustomCallback" runat="server" AutoGenerateColumns="False" Theme="Office2003Blue" Width="100%" KeyFieldName="ID">
...
grdAccessCalendarEndCallBack(s,e);	
                        ...
                        <section id="sectionAccessProfile" class="bottomlblleft">
                            <section class="topContHolder">
                                ...
                                <dx:ASPxComboBox ID="dplAccessProfileNr" runat="server" CssClass="ddlProfil2" ValueField="ID" TextField="AccessDescription"
                                    DropDownRows="20" DropDownWidth="600px" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" TextFormatString="{2}" Theme="Office2003Blue">
                                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
	SetProfileSelectedDxDrp(s.GetValue());
}"
                                       />
                                    <Columns>
                                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, groupProfileNo %>" FieldName="AccessGroup.AccessGroupNumber" Name="AccessGroupNumber" ToolTip="<%$ Resources:localizedText, groupProfileNo %>" Width="19%" />
                                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, grpDescription %>" FieldName="AccessGroup.AccessGroupName" Name="AccessGroupName" ToolTip="<%$ Resources:localizedText, grpDescription %>" Width="36%" />
                                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, profileNo %>" FieldName="AccessProfileNo" Name="AccessProfileNo" ToolTip="<%$ Resources:localizedText, profileNo %>" Width="15%" />
                                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, profileDescription %>" FieldName="AccessDescription" Name="AccessDescription" ToolTip="<%$ Resources:localizedText, profileDescription %>" Width="36%" />
                                         <dx:ListBoxColumn Caption="Profil ID:" FieldName="AccessProfileID" Name="AccessProfileID" ToolTip="Profil ID:" Width="15%" />
                                    </Columns>
                                </dx:ASPxComboBox>
                                ...
                                <dx:ASPxComboBox ID="dplAccessProfileName" runat="server" ValueType="System.String" CssClass="ddlProfil" ValueField="ID" TextField="AccessDescription"
                                    DropDownRows="20" DropDownWidth="600px" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" TextFormatString="{3}"
	...
	SetProfileSelectedDxDrp(s.GetValue());	
                                ...
                                <dx:ASPxComboBox ID="ddlProfileId" runat="server" CssClass="ddlProfil2id" ValueField="ID" TextField="AccessProfileID" ValueType="System.String" Theme="Office2003Blue"  DropDownRows="20" DropDownWidth="600px" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" TextFormatString="{4}" IncrementalFilteringMode="Contains" SelectedIndex="0" >
                                 <ClientSideEvents SelectedIndexChanged="function(s, e) {
	SetProfileSelectedDxDrp(s.GetValue());	
}" />
                                    <Columns>
                            ...
                            <asp:Button ID="btnNewAccessProfile" runat="server" Text="<%$ Resources:localizedText, accessProfile1 %>" OnClick="btnNewAccessProfile_Click" CssClass="newstandardbutton"  Style="cursor:pointer !important;" />
                        </section>
                                ...
                                <section class="rightbottom3">
                                    <div class="intergrated3">
                                        ...
                                        <section class="rightDivs2">
                                            ...
                                            <section class="last">
                                                <section class="griddatemover" style="border: none;">
                                                    <section class="griddatemoverleft" Style="display:none">
                                                        <asp:Button ID="btnDateFromPrevious"  runat="server" Text="" CssClass="korbtnFvNavPrevNr" />
                                                    </section>
                                                    <section class="griddatemovercenter" style="width:105px;">
                                                        <dx:ASPxDateEdit ID="datePickerDateFrom" ClientInstanceName="datePickerDateFrom" Theme="Office2003Blue" runat="server" CssClass="dateraound ddlYearStyle2" HorizontalAlign="Center">
                                                        <ClientSideEvents DateChanged="datePickerFromDateChanged" />
                                                        </dx:ASPxDateEdit>
                                                    </section>
                                                    <section class="griddatemoverright" Style="display:none">
                                        ...
                                        <section class="rightDivs1">
                                            ...
                                            <section class="center" >
                                                <section class="griddatemover" style="border: none;">
                                                    ...
                                                    <section class="griddatemovercenter" style="width:105px;">
                                                        <dx:ASPxDateEdit ID="datePickerDateTo" ClientInstanceName="datePickerDateTo" Theme="Office2003Blue" runat="server" CssClass="dateraound ddlYearStyle2" HorizontalAlign="Center">
                                                        <ClientSideEvents DateChanged="datePickerToDateChanged" />
                                                        </dx:ASPxDateEdit>
                                                    </section>
                                                    <section class="griddatemoverright" Style="display:none">
                                    ...
                                    <div class="intergrated4">
                                        <asp:Button ID="btnApply" runat="server" Text="<%$ Resources:localizedText, takeover %>" CssClass="applybtnfooterorange" style="float:right; width:87px; margin:0px;"/>
                                    </div>
                                </section>
                            </div>
                        </section>
                ...
                <section class="tblAccessProfiles" style="display: none;">
                    <section class="sectionGridsd">
                        ...
                        <dx:ASPxGridView ID="grdZuttritProfileTimeFrames" runat="server" AutoGenerateColumns="False" UseDisabledStatePainter="false" SettingsBehavior-AllowSort="false" Theme="Office2003Blue"
                            CssClass="grid" Width="100%" ClientInstanceName="grdZuttritProfileTimeFrames" KeyFieldName="ID" OnCustomCallback="grdZuttritProfileTimeFrames_CustomCallback"  ForeColor="Black">
	...
	activateProfile(s, e);
            ...
            <div class="secCalendarSelection">
                ...
                <section class="midGridClass">
                    <dx:ASPxGridView ID="grdHolidayCalndr" ClientInstanceName="grdHolidayCalndr" OnCustomCallback="grdHolidayCalndr_CustomCallback"  EnableCallBacks="true" runat="server" Width="100%" KeyFieldName="ID" Theme="Office2003Blue" AutoGenerateColumns="False">
	...
	grdHolidayCalndrSingleClick(s,e)
                ...
                <section class="secFooter">
                    <asp:Button ID="btnApplySelectedCalender" ClientIDMode="Static" runat="server" Text="Kalender übernehmen" CssClass="applybtnfooterorange" Style="text-align: right !important; float: right; margin-top: 0;" />
                </section>
            </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    ...
    <asp:Button ID="btnSaveAccessPlan" CssClass="savebtnfootergreen" runat="server" Text="<%$ Resources:localizedText, accesscalendersave %>" Style="width: 164px !important;" />
