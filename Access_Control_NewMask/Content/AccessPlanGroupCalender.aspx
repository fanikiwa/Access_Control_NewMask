<%@ Page Title="Zutrittsgruppen- Zutrittsplan" Language="C#" MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="AccessPlanGroupCalender.aspx.cs" Inherits="Access_Control_NewMask.Content.AccessPlanGroupCalender" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"> 
<script src="Scripts/AccessPlanGroupCalender.js"></script>
<link href="Styles/AccessPlanGroupCalender.css" rel="stylesheet" />
               ...
               <section class="leftDvnsnewab">
                   <div class="ControlSecarea2" style="display: none;">
                        ...
                        <asp:Button ID="Search" runat="server" Text="" CssClass="searchzutarea" />
                            ...
                            <asp:Label runat="server" Text="Zutrittsgruppen Nr.:" CssClass="planGruppenfnew"></asp:Label>
                            <asp:TextBox ID="txtAccessGroupNr" Enabled="false" ClientIDMode="Static" runat="server" CssClass="Gruppenfnew"></asp:TextBox>
                            <asp:Label runat="server" Text=" <%$ Resources:localizedText, description_new %>" CssClass="planGruppengtext"></asp:Label>
                            <asp:TextBox ID="txtAccessGroupName" Enabled="false" ClientIDMode="Static" runat="server" CssClass="Gruppengcalendernew"></asp:TextBox>
                            <asp:TextBox ID="txtAccessGroupId" Style="display:none" runat="server"></asp:TextBox>
               </section>
                        <section class="rightDvnsnewab">
                            <asp:Button ID="btnPersonnel" runat="server" Text="" CssClass="newstandardbutton Personenbutton2newabcd" ></asp:Button>
                            <span class="arrowpoint"></span>
<%--                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />--%>
                            <asp:Button ID="btnMembers" runat="server" Text="" cssclass="newstandardbutton memberbutton2"></asp:Button>
                               <span class="arrowpoint"></span>
<%--				            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />--%>
                            <asp:Button ID="btnReader" runat="server" Text="<%$ Resources:localizedText, reader %>" CssClass="newstandardbutton Leserbutton1newabcd"></asp:Button>
                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
                            ...
                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
                            <asp:Button ID="btnHoliday" runat="server" Text="<%$ Resources:localizedText, holidaySchedule%>" Enabled="true" CssClass="newstandardbutton Zutrittsprofilbutton2textnewabcd"></asp:Button>
...
grdAccessCalendarEndCallBack(s,e);	
	...
	SetProfileSelectedDxDrp(s.GetValue());	
                            ...
                            <asp:Button ID="btnNewAccessProfile" runat="server" Text="<%$ Resources:localizedText, accessProfile1 %>" CssClass="newstandardbutton"  Style="cursor:pointer !important;" />
                        </section>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
         <asp:Button ID="btnNew" CssClass="newbtnfooterblue" runat="server" Text="<%$ Resources:localizedText, accesscalendernew %>" Style="width: 135px !important;"  />
