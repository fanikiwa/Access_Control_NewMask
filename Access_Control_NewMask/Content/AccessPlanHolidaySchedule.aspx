<%@ Page Title="Zutrittsplan - Feiertagsplan" Language="C#"  MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="AccessPlanHolidaySchedule.aspx.cs" Inherits="Access_Control_NewMask.Content.AccessPlanHolidaySchedule" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/AccessPlanHolidaySchedule.js"></script>
    <link href="Styles/AccessPlanHolidaySchedule.css" rel="stylesheet" />
            ...
            <section class="topdivNew">
                <div id="ControlSecarea" class="ControlSecarea1New">
                    <div class="ControlSecarea2" style="display: none;">
                        ...
                        <asp:DropDownList ID="ddlAccessGroupNumber" Enabled="false" ClientIDMode="Static" DataValueField="Id" DataTextField="AccessGroupNumber" runat="server" AutoPostBack="true" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" CssClass="planGruppen2"></asp:DropDownList>
                        <asp:Label runat="server" Text="<%$ Resources:localizedText, groupName %>" CssClass="planGruppen3"></asp:Label>
                        <asp:DropDownList ID="ddlAccessGroupName" Enabled="false" ClientIDMode="Static" DataValueField="Id" DataTextField="AccessGroupName" runat="server" AutoPostBack="true" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" CssClass="planGruppen4"></asp:DropDownList>
                        <asp:Label runat="server" Text="<%$ Resources:localizedText, accessPlanNo %>" CssClass="planGruppen5"></asp:Label>
                        <asp:DropDownList ID="ddlAccessPlanNumber" Enabled="false" ClientIDMode="Static" DataValueField="ID" DataTextField="AccessPlanNr" runat="server" AutoPostBack="true" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" CssClass="planGruppen6"></asp:DropDownList>
                        <asp:Label runat="server" Text="<%$ Resources:localizedText, description1 %>" CssClass="planGruppen7"></asp:Label>
                        <asp:DropDownList ID="ddlAccessPlanName" Enabled="false" ClientIDMode="Static" DataValueField="ID" DataTextField="AccessPlanDescription" runat="server" AutoPostBack="true" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" CssClass="planGruppen8"></asp:DropDownList>

                        <%--<asp:Button ID="Button1" runat="server" Text="" CssClass="searchzutarea" />--%>
                    </div>
                    <div class="ControlSecarea3">
                        <section class="leftDvns">
                            ...
                            <asp:Label runat="server" Text="<%$ Resources:localizedText, accessplannumber %>" CssClass="planGruppenf"></asp:Label>
                            <asp:TextBox ID="txtAccessProfileNumber" Enabled="false" ClientIDMode="Static" runat="server" CssClass="Gruppenf"></asp:TextBox>
                            <asp:Label runat="server" Text="<%$ Resources:localizedText, description1 %>" CssClass="planGruppeng"></asp:Label>
                            <asp:TextBox ID="txtAccessProfileName" Enabled="false" ClientIDMode="Static" runat="server" CssClass="Gruppeng"></asp:TextBox>
                        </section>
                        <section class="rightDvns">
                            <asp:Button ID="btnPersonnel" runat="server" Text="<%$ Resources:localizedText, people %>" CssClass="newstandardbutton Personenbutton2" PostBackUrl="~/Content/AccessPlanPersonal.aspx"></asp:Button>
                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
                            <asp:Button ID="btnMembers" runat="server" Text="Mitglieder" cssclass="newstandardbutton Personenbutton2" PostBackUrl="~/Content/AccessPlanMembers.aspx" ></asp:Button>
                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
                            <asp:Button ID="btnReader" runat="server" Text="<%$ Resources:localizedText, reader %>" CssClass="newstandardbutton Leserbutton2" PostBackUrl="~/Content/AccessPlanReader.aspx"></asp:Button>
                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
                            <asp:Button ID="btnAccessProfile" runat="server" Text="<%$ Resources:localizedText, accessCalendar%>" CssClass="newstandardbutton Zutrittsprofilbutton2" PostBackUrl="~/Content/AccessPlanAccessCalender.aspx"></asp:Button>
                            <img src="../Images/FormImages/arrowpoint.png" class="arrowpoint" />
