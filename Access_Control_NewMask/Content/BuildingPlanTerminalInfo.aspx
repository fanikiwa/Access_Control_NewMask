<%@ Page Title="<%$ Resources:localizedText, buildingPlan %>" Language="C#" MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="BuildingPlanTerminalInfo.aspx.cs" Inherits="Access_Control_NewMask.Content.BuildingPlanTerminalInfo" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/BuildingPlanTerminalInfo.js"></script>
    <link href="Styles/BuildingPlanTerminalInfo.css" rel="stylesheet" />
</asp:Content>
        ...
        <div class="grdSec">
            <section class="gridSection"> 
                <dx:ASPxGridView ID="grvTerminalInfo" ClientInstanceName="grvTerminalInfo" runat="server" SettingsBehavior-AllowDragDrop="false" SettingsBehavior-AllowSort="false" AutoGenerateColumns="False"
                    EnableTheming="True" Theme="Office2003Blue" OnHtmlRowPrepared="grvTerminalInfo_HtmlRowPrepared"  OnHtmlDataCellPrepared="grvTerminalInfo_HtmlDataCellPrepared" Width="100%" >
