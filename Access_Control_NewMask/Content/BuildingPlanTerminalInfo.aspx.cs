...
{
    public partial class BuildingPlanTerminalInfo : BasePage
    {
        ...
        protected void LoadTerminalByID()
        {
            ...
            //grvTerminalInfo.DataSource = terminalDetails.Where(x => x.DoorID == doorId);
        ...
        {
            Session["FromPage"] = "BuildingPlanTerminalInfo.aspx";
        ...
        {
            HttpContext.Current.Session["FromPage"] = "BuildingPlanTerminalInfo.aspx";
        ...
        protected void BuildingPlanHolidayPlanSwitchProfilesPerTerminal_Click(object sender, ImageClickEventArgs e)
        {
            Session["FromPage"] = "BuildingPlanTerminalInfo.aspx";
        ...
        protected void ImageButtonTermConfig_Click(object sender, ImageClickEventArgs e)
        {
            ...
            var pageOrigin = 2;//BuildingPlanTerminalInfo.aspx
