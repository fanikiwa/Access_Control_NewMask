<%@ Page Title="<%$ Resources:localizedText, displayPanel %>" Language="C#" MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="Displaypanel.aspx.cs" Inherits="Access_Control_NewMask.Content.Displaypanel" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/Displaypanel.js"></script>
    <link href="Styles/Displaypanel.css" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHolder" runat="server">
      <div class="mainareaplace1">
        <div class="topareaplace1">
            ...
            <asp:Label ID="Label1" runat="server" Text="<%$ Resources:localizedText, present2 %>" CssClass="lblabwes"></asp:Label>
            ...
            <asp:CheckBox ID="chkPresent" runat="server"  CssClass="chkActivation"/>
             <asp:Label ID="Label2" runat="server" Text="<%$ Resources:localizedText, absent2 %>" CssClass="lblabsew"></asp:Label>
        ...
        <div class="gridareaplace1">
            <dx:ASPxGridView ID="grdBookings" ClientInstanceName="grdBookings" EnableCallBacks="true" OnCustomCallback="grdBookings_CustomCallback" OnCustomButtonInitialize="grdBookings_CustomButtonInitialize" KeyFieldName="IDNr" runat="server"  AutoGenerateColumns="False"  Width="100%"  CssClass="redgreen">
                                ...
                                <dx:GridViewCommandColumnCustomButton ID="Status1" Text="<%$ Resources:localizedText, status2 %>">
                                    ...
                                    <dx:GridViewCommandColumn Width="2%" Caption="<%$ Resources:localizedText, status2 %>" VisibleIndex="13" HeaderStyle-BackColor="darksalmon" HeaderStyle-ForeColor="black" ShowNewButton="false" ShowEditButton="false" ButtonType="Image">
                                        <CustomButtons>
                                <dx:GridViewCommandColumnCustomButton ID="Status2" Text="<%$ Resources:localizedText, status2 %>">
                                    <Image ToolTip="<%$ Resources:localizedText, status2 %>" Url="../Images/FormImages/btn_reddisplay.png" />
                                    ...
                                    <dx:GridViewCommandColumn Width="2%" Caption="<%$ Resources:localizedText, status2 %>" VisibleIndex="20" HeaderStyle-BackColor="darksalmon" HeaderStyle-ForeColor="black" ShowNewButton="false" ShowEditButton="false" ButtonType="Image">
                                        <CustomButtons>
                                <dx:GridViewCommandColumnCustomButton ID="Status3" Text="<%$ Resources:localizedText, status2 %>">
                                    <Image ToolTip="<%$ Resources:localizedText, status2 %>" Url="../Images/FormImages/btn_reddisplay.png" />
