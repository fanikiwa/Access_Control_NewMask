...
{
    public partial class GateDisplaypanel : BasePage
    {
        ...
        public static accessControlPermissionModes AccessControlPermissionMode
        {
            get
            {
                return ZUTMain.LoadSessionItem<accessControlPermissionModes>("GateMonitorDisplayPanel_PMode");
            }
            set
            {
                HttpContext.Current.Session["GateMonitorDisplayPanel_PMode"] = value;
            }
        }
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            if (!mainCtl.CheckForReadOrWritePermissions(accessControlPermissions.GateMonitorDisplayPanel, out _AccessControlPermissionMode))
        ...
        {
            Response.Redirect("GateMonitor.aspx");
        }
        ...
        protected void grdBookings_CustomButtonInitialize(object sender, ASPxGridViewCustomButtonEventArgs e)
        {
