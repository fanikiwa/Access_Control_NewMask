...
{
    public partial class GateMembers : BasePage
    {
        ...
        {
            var member = new MembersDataRepository().GetMemberDataById(ID, true);
            if (member != null)
            {
        ...
        {
            long nextNr = 0;
            var members = new MembersDataRepository().GetAllMembersData(true);
            if (members.Count > 0)
            {
