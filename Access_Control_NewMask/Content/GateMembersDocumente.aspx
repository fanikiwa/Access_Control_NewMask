<%@ Page Title="<%$ Resources:localizedText, membersdocument %>" Language="C#" MasterPageFile="~/MasterPages/Gate.Master" AutoEventWireup="true" CodeBehind="GateMembersDocumente.aspx.cs" Inherits="Access_Control_NewMask.Content.GateMembersDocumente" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/GateMembersDocumente.js"></script>
    <link href="Styles/GateMembersDocumente.css" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterLeft" runat="server">
    ...
    <section class="leftinfo1">
        ...
        <asp:Button ID="btnEntSave" CssClass="BottomFooterBtnsLeft savebtnfootergreen" runat="server" Text="Personalausweis speichern" Style="width: 219px; margin-left: 0;" />
