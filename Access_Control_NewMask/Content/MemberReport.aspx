<%@ Page Title="<%$ Resources:localizedText, memberAccessProtocols %>" Language="C#" ClientIDMode="Static" MasterPageFile="~/MasterPages/Reports.Master" AutoEventWireup="true" CodeBehind="MemberReport.aspx.cs" Inherits="Access_Control_NewMask.Content.MemberReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="Styles/MemberReport.css" rel="stylesheet" />
    <script src="Scripts/MemberReport.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <div class="ContentAreaDiv">
        <div id="ControlSection1" class="TopContentAreaDiv">
            ...
            <dx:ASPxComboBox ID="cboAccesReportNo" CallbackPageSize="10000" ValueField="ID" ClientInstanceName="cboAccesReportNo" TextField="Nr" SelectedIndex="0" Theme="Office2003Blue" runat="server" ValueType="System.String" CssClass="cboAccsPrtNr" OnCallback="cboAccesReportNo_Callback"
            ...
            <%--<asp:Label ID="Label2" runat="server" Text="Bezeichnung:" CssClass="lblAccProtDesc"></asp:Label>--%>
            ...
            <dx:ASPxComboBox ID="cboAccesReportDesc" CallbackPageSize="10000" ClientInstanceName="cboAccesReportDesc" ValueField="ID" TextField="Name" SelectedIndex="0" Theme="Office2003Blue" runat="server" ValueType="System.String" CssClass="cboAccProtDesc" OnCallback="cboAccesReportDesc_Callback"
            ...
            <%-- date --%>
            <asp:Label ID="Label3" runat="server" Text="<%$ Resources:localizedText, date_new %>" CssClass="lblDateTitleNew"></asp:Label>
        ...
        <div id="MainContdiv">
            ...
            <div class="fluidarea">
                ...
                <section class="secTopRight">
                    <asp:Label ID="Label59" runat="server" Text="<%$ Resources:localizedText, selectionOfReports %>" CssClass="lblprselect" Style="width: 48%"></asp:Label>
                    ...
                    <section class="secControlsOne">
                        <section class="secDvnOne">
                            <section class="secHeightDvn">
                                ...
                                <%-- <dx:ASPxDateEdit ID="ASPxDateEdit1" Theme="Office2003Blue" CssClass="dtFrom" runat="server">
                                </dx:ASPxDateEdit>--%>
                    ...
                    <section class="secControlsTwo">
                        <section class="secDvnOne">
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cbolocation" CallbackPageSize="10000" ClientIDMode="Static" ClientInstanceName="cbolocation" runat="server" Theme="Office2003Blue"
	 ...
	 LocationIndexChanged(s, e);
                            ...
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cboBuilding" CallbackPageSize="10000" ValueField="BuildingID" TextField="BuildingName" ClientIDMode="Static" ClientInstanceName="cboBuilding"
                                    runat="server" Theme="Office2003Blue" ValueType="System.String" SelectedIndex="0" CssClass="cboSecControlsTwo" DropDownWidth="480px" DropDownRows="10"
                                    TextFormatString="{1}"
	 ...
	 BuildingsIndexChanged(s, e);
                            ...
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cboLevels" CallbackPageSize="10000" ValueField="LevelID" TextField="Level" ClientIDMode="Static" ClientInstanceName="cboLevels" runat="server"
	 ...
	 LevelsIndexChanged(s, e);
                                    ...
                                    <Columns>
                                        ...
                                        <dx:ListBoxColumn FieldName="BuildingName" Name="BuildingName" Width="32%" Caption="Gebaüde:" ToolTip="<%$ Resources:localizedText, building_NewP %>"></dx:ListBoxColumn>
                            ...
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cboRooms" CallbackPageSize="10000" ValueField="RoomID" TextField="Room" runat="server" Theme="Office2003Blue" ValueType="System.String"
                                    CssClass="cboSecControlsTwo" DropDownWidth="680px" SelectedIndex="0" DropDownRows="10" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
	 ...
	 RoomsIndexChanged(s, e);
                            ...
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cboDoors" CallbackPageSize="10000" ValueField="DoorID" TextField="Door" runat="server" SelectedIndex="0" Theme="Office2003Blue" ValueType="System.String"
	 ...
	 DoorsIndexChanged(s, e);
                        ...
                        <section class="secDvnTwo">
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cbolocationto" CallbackPageSize="10000" ClientIDMode="Static" ClientInstanceName="cbolocationto" runat="server"
	 ...
	 LocationIndexChanged(s, e);
                            ...
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cboBuildingTo" CallbackPageSize="10000" ValueField="BuildingID" TextField="BuildingName" runat="server" Theme="Office2003Blue" CssClass="cboSecControlsTwo_new" DropDownWidth="480px" DropDownRows="10" TextFormatString="{1}"
                                    Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" SelectedIndex="0" Font-Size="14px" OnCallback="cboBuildingTo_Callback" EnableCallbackMode="True">
                                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
	 BuildingsIndexChanged(s, e);
}"
	...
	EndCallbackBuildings(s, e);
                            ...
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cboLevelsTo" CallbackPageSize="10000" ValueField="LevelID" ClientInstanceName="cboLevelsTo" TextField="Level" runat="server" Theme="Office2003Blue" ValueType="System.String"
	...
	EndCallbackFloors(s, e);
                            ...
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cboRoomsTo" CallbackPageSize="10000" ValueField="RoomID" TextField="Room" SelectedIndex="0" runat="server" Theme="Office2003Blue"
                                    CssClass="cboSecControlsTwo_new" DropDownWidth="680px" DropDownRows="10" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
	...
	EndCallbackRooms(s, e);
                            ...
                            <section class="secFivDvns">
                                ...
                                <dx:ASPxComboBox ID="cboDoorTo" CallbackPageSize="10000" ValueField="DoorID" TextField="Door" runat="server" SelectedIndex="0" Theme="Office2003Blue" CssClass="cboSecControlsTwo_new"
                    ...
                    <section class="secControlsThree">
                        <section class="secDvnOne">
                            <section class="SecControlsThreeDvns">
                                <asp:Label ID="Label35" runat="server" Text="<%$ Resources:localizedText, studioGroupFrom %>" CssClass="lblSecControlsTwo"></asp:Label>
                                ...
                                <dx:ASPxComboBox ID="cboClientName" CallbackPageSize="10000" TextFormatString="{1}" DropDownWidth="480px" DropDownRows="10" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px" ClientIDMode="Static" ClientInstanceName="cboClientName" runat="server" SelectedIndex="0" ValueField="ID" TextField="GroupName" Theme="Office2003Blue" ValueType="System.String" CssClass="cboSecControlsTwo">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:ListBoxColumn Caption=" <%$ Resources:localizedText, companynew %>" FieldName="GroupName" Width="80%" />
                                    </Columns>
                                </dx:ASPxComboBox>
                            </section>
                            <section class="SecControlsThreeDvns">
                            ...
                            <section class="SecControlsThreeDvns">
                                <asp:Label ID="Label37" runat="server" Text="<%$ Resources:localizedText ,LongTermCardNrFrom%>" CssClass="lblSecControlsTwo"></asp:Label>
                        ...
                        <section class="secDvnTwo">
                            ...
                            <section class="SecControlsThreeDvns">
                                ...
                                <%--<dx:ASPxComboBox ID="ASPxComboBox23" runat="server" Theme="Office2003Blue" ValueType="System.String" CssClass="cboSecControlsTwo_new"></dx:ASPxComboBox>--%>
                        ...
                        <section class="secDvnThree">
                            <section class="secLeftHeaders">
                                <asp:Label ID="Label49" runat="server" Text="<%$ Resources:localizedText, studioGruppe %>" CssClass="lblSecTwoControls"></asp:Label>
                                <asp:Label ID="Label50" runat="server" Text="<%$ Resources:localizedText, nameFrom %>" CssClass="lblSecTwoControls"></asp:Label>
                                ...
                                <asp:Label ID="Label54" runat="server" Text="<%$ Resources:localizedText, longTermCardNr %>" CssClass="lblSecTwoControls"></asp:Label>
                    ...
                    <section class="secGrid">
                        <%--<dx:ASPxGridView ID="grdReport" runat="server" ClientInstanceName="grdReport" Styles-Header-BackColor="White" Theme="Default" AutoGenerateColumns="False" Width="100%">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Nr.:" Width="12%"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn VisibleIndex="2" Caption="Bezeichnung:" Width="88%"></dx:GridViewDataTextColumn>
                            </Columns>
                        </dx:ASPxGridView>--%>
                        ...
                        <dx:ASPxGridView ID="grdReport" ClientIDMode="Static" ClientInstanceName="grdReport" runat="server" KeyFieldName="ID" Styles-Header-BackColor="White" Theme="Default" AutoGenerateColumns="False" Width="100%" OnCustomCallback="grdReport_CustomCallback">
                            <SettingsPager PageSize="21" ShowEmptyDataRows="true" Visible="False"></SettingsPager>
...
grdReportRowClick(s,e);
    ...
    <section class="showReports" style="display: none">
            ...
            <section class="mainBodyTop1 ">
                <section class="mainBodyTop1left">
                    <section class="mainBodyTop1leftlbl">
                        ...
                        <asp:Label ID="Label39" runat="server" Text="<%$ Resources:localizedText, studioGroupFrom %>" CssClass="lblreport"></asp:Label>
                    </section>
                ...
                <section class="mainBodyTop1left2">
                    <section class="mainBodyTop1leftlbl2">
                        <asp:Label ID="Label40" runat="server" Text="<%$ Resources:localizedText, to_new %>" CssClass="lblBis"></asp:Label>
                ...
                <section class="mainBodyTop1left3">
                    <section class="selectionOne">
                        ...
                        <section class="topRight2 topRight2area">
                            <asp:Label ID="Label70" runat="server" Text="<%$ Resources:localizedText, SelectionType %>" CssClass="lblPrintModeareanew"></asp:Label>
        ...
        <section class="mainBodybtm">
            <dx:ASPxGridView ID="grdShoeReport" runat="server" ClientIDMode="Static" ClientInstanceName="grdShoeReport" Theme="Office2003Blue" AutoGenerateColumns="False" SettingsPager-PageSize="13" KeyFieldName="ID" SettingsPager-ShowEmptyDataRows="True" Width="100%" OnCustomCallback="grdShoeReport_CustomCallback">
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn Caption="Tür/Leser" VisibleIndex="5" FieldName="BPDoor"></dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, studioGruppe %>" Visible="false" VisibleIndex="8" FieldName="MemberGroup"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Name" VisibleIndex="9" Visible="false" FieldName="Name"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, longTermCardNr %> " Visible="false" VisibleIndex="10" FieldName="CardNumber"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, shortTermCardNr %>" Visible="false" VisibleIndex="11" FieldName="CardNumbershort"></dx:GridViewDataTextColumn>
                </Columns>
            </dx:ASPxGridView>
        </section>
    </section>
        ...
        <dx:ASPxCallbackPanel ID="OneTodayCallbackPanel" runat="server" OnCallback="OneTodayCallbackPanel_Callback">
            <PanelCollection>
                <dx:PanelContent runat="server">
                    <dx:ASPxWebDocumentViewer ID="MemberReportASPxDocumentViewer" Style="width: 100%; height: 100%;" ClientIDMode="Static" ClientInstanceName="TodayLocalASPxDocumentViewer" runat="server" Theme="Office2003Blue">
    ...
    <section class="showReportsPersonal" style="display: none">
            ...
            <section class="mainBodyTop1 ">
                <section class="mainBodyTop1left">
                    <section class="mainBodyTop1leftlbl">
                        ...
                        <asp:Label ID="Label80" runat="server" Text="<%$ Resources:localizedText, studioGroupFrom %>" CssClass="lblreport"></asp:Label>
                    </section>
                    <section class="mainBodyTop1leftdrp">
                        ...
                        <asp:TextBox ID="txtStudioGruppeFrom" runat="server" CssClass="drpreport"></asp:TextBox>
                ...
                <section class="mainBodyTop1left2">
                    ...
                    <section class="mainBodyTop1leftdrp4New">
                        ...
                        <asp:TextBox ID="txtStudioGruppeTo" runat="server" CssClass="drpreportnew"></asp:TextBox>
                ...
                <section class="mainBodyTop1left3">
                    <section class="selectionOne">
                        ...
                        <section class="topRight2" style="width: 20%">
                            <asp:Label ID="Label87" runat="server" Text="<%$ Resources:localizedText, SelectionType %>" CssClass="lblPrintMode lblPrintModearea"></asp:Label>
                    ...
                    <section class="selectionTwo">
                        ...
                        <section class="topRight2">
                            <asp:Label ID="Label93" runat="server" Text="<%$ Resources:localizedText, selectedTimeRange %>" CssClass="lblPrintMode lblPrintMode2area"></asp:Label>
                            <asp:Label ID="Label94" runat="server" Text="" CssClass="lblTimeHrsMode"></asp:Label>
                        </section>
                        <section class="topRight3">
                        </section>
                    </section>
                    <section class="selectionThree">
                        ...
                        <section class="topRight2">
                            <section class="loggedInUser">
                                ...
                                <asp:Label ID="Label98" runat="server" Text="" CssClass="lblPersNameText"></asp:Label>
                            </section>
                        </section>
                        <section class="topRight3perpekind">
                            <section class="secholdingarea1_new">
                                <asp:Label ID="Label41" runat="server" Text="<%$ Resources:localizedText, potrait %>" CssClass="txtportrait"></asp:Label>
                            ...
                            <section class="secholdingarea1b_new">
                                <asp:Label ID="Label46" runat="server" Text="<%$ Resources:localizedText, landScape %>" CssClass="txtlandscape_new"></asp:Label>
        ...
        <section class="mainBodybtm">
            <dx:ASPxGridView ID="grdPersonalAccessReport" runat="server" Theme="Office2003Blue" KeyFieldName="ID" OnCustomCallback="grdPersonalAccessReport_CustomCallback" ClientInstanceName="grdPersonalAccessReport" AutoGenerateColumns="False" SettingsPager-PageSize="13" SettingsPager-ShowEmptyDataRows="True" Width="100%">
                <SettingsBehavior AllowSort="true" AllowFocusedRow="True" AllowDragDrop="False" AllowGroup="False" AutoExpandAllGroups="True" />
                <SettingsDataSecurity AllowEdit="False" AllowInsert="False" AllowDelete="False"></SettingsDataSecurity>
                <Columns>
                    <dx:GridViewDataTextColumn Caption="ID" Visible="False" VisibleIndex="0" FieldName="ID"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, studioGruppe %>" VisibleIndex="1" FieldName="MemberGroup"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="Name:" VisibleIndex="2" Visible="false" FieldName="Name"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, longTermCardNr %>" VisibleIndex="3" FieldName="CardNumber"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, shortTermCardNr %>" VisibleIndex="4" FieldName="CardNumbershort"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataDateColumn FieldName="BookingDate" Caption="<%$ Resources:localizedText, date_new %>" VisibleIndex="5">
                        <HeaderStyle HorizontalAlign="Center" />
                        <CellStyle HorizontalAlign="Center"></CellStyle>
                        <PropertiesDateEdit DisplayFormatString="dd.MM.yyyy" EditFormatString="dd.MM.yyyy"></PropertiesDateEdit>
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTimeEditColumn FieldName="BookingTime" Caption="<%$ Resources:localizedText, time_newP %>" VisibleIndex="6">
                        <PropertiesTimeEdit DisplayFormatString="HH:mm" EditFormat="Time" EditFormatString="HH:mm" Height="25px"></PropertiesTimeEdit>
                    </dx:GridViewDataTimeEditColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, location_new %> " VisibleIndex="7" FieldName="BPLocation"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, building_NewP %>" VisibleIndex="8" FieldName="BPBuilding"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, level_NewP %>" VisibleIndex="9" FieldName="BPLevel"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, room_new %>" VisibleIndex="10" FieldName="BPRoom"></dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, doorReader_NewP %>" VisibleIndex="11" FieldName="BPDoor"></dx:GridViewDataTextColumn>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    <%-- <asp:Button ID="btnNew" CssClass="newProtocol" runat="server" Text="Zutrittsprotokoll Neu" />
    <asp:Button ID="btnEntSave" CssClass="saveProtocol" runat="server" Text="Zutrittsprotokoll speichern" />
    <asp:Button ID="btnCancelDel" CssClass="deleteProtocol" runat="server" Text="Zutrittsprotokoll löschen" />
    <asp:Button ID="btnApply" CssClass="btnPrintReport" runat="server" Text="Zutrittsprotokoll drucken" />--%>
