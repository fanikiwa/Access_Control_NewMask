<%@ Page Title="<%$ Resources:localizedText, members %>" Language="C#" MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="Members.aspx.cs" Inherits="Access_Control_NewMask.Content.Members" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/Members.js?v=<%= Access_Control_NewMask.Controllers.Version.JSVersion %>"></script>
    <script src="Scripts/Webcamscripts/webcam.min.js"></script>
    <script src="Scripts/TakePhoto.js"></script>
    <link href="Styles/Members.css?v=<%= Access_Control_NewMask.Controllers.Version.JSVersion %>" rel="stylesheet" />
    ...
    <div id="ControlSection1" class="ControlSection">
        ...
        <div id="AEHeaderLeftDiv">
            <div id="BottomHeaderLabels">
                <asp:Label ID="Label45" runat="server" Text="<%$ Resources:localizedText, studiogrpno %>" CssClass="L1HeaderT1drplablesmandant"></asp:Label>
                ...
                <dx:ASPxComboBox ID="cobMemberGroupNr" ClientInstanceName="cobMemberGroupNr" runat="server" ValueField="ID" TextField="GroupNumber" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
                    TextFormatString="{0}" CssClass="lblMandant ColorBlue" DropDownRows="20" DropDownWidth="400px" Theme="Office2003Blue" EnableCallbackMode="true" OnCallback="cobMemberGroupNr_Callback" CallbackPageSize="20">
...
//dplGroupClick(s,e);
                ...
                <dx:ASPxComboBox ID="cobMemberGroupName" ClientInstanceName="cobMemberGroupName" ClientIDMode="Static" runat="server" ValueField="ID" TextField="GroupName" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
                    TextFormatString="{1}" CssClass="L1HeaderT1drplists ColorBlue" DropDownRows="20" DropDownWidth="400px" Theme="Office2003Blue" EnableCallbackMode="true" OnCallback="cobMemberGroupName_Callback" CallbackPageSize="20">
                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
...
dplGroupClick(s,e);
                ...
                <asp:Label ID="lblLocationHeader" runat="server" Text="<%$ Resources:localizedText, membersno %>" CssClass="L1HeaderT1drplables"></asp:Label>
                ...
                <dx:ASPxComboBox ID="cobMemberNr" ClientInstanceName="cobMemberNr" runat="server" ValueField="ID" TextField="MemberNumber" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
                    TextFormatString="{0}" CssClass="lblMandant ColorBlue" DropDownRows="20" DropDownWidth="400px" Theme="Office2003Blue" EnableCallbackMode="true" OnCallback="cobMemberNr_Callback" CallbackPageSize="20">
                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
...
cobMemberNrEndCallBack(s,e)	;
                ...
                <dx:ASPxComboBox ID="cobMemberName"
                    ...
                    OnCallback="cobMemberName_Callback" CallbackPageSize="20">
                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
...
dpMemberClick(s,e);
	...
	cobMemberNameEndCallBack(s,e);
        ...
        <div class="textsearcharea">
            ...
            <asp:UpdatePanel ID="upPnl_MemberNameSearch" runat="server" style="overflow: visible !important; width: 100% !important; z-index: 999999 !important;">
                <ContentTemplate>

                    <dx:ASPxComboBox ID="ASPxComboBox1" runat="server" ValueType="System.String" CssClass="drpmemberstext ColorBlue" Visible="false"></dx:ASPxComboBox>
                    ...
                    <dx:ASPxComboBox ID="cboMemberNameSearch" ClientInstanceName="cboMemberNameSearch" runat="server" EnableCallbackMode="True" ValueField="ID" ValueType="System.String" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif"
                        ...
                        DropDownStyle="DropDown" DropDownRows="20" DropDownWidth="500px" CallbackPageSize="20" Style="overflow: visible !important; width: 90% !important; z-index: 9999999 !important;">
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
...
cobSalutationSelectedChanged(s,e);
	...
	cobDurationSelectedChanged(s,e);
                                    ...
                                    <Columns>
                                        <dx:ListBoxColumn Caption="Nr:" FieldName="DurationNr" Name="DurationNr" />
                                        <dx:ListBoxColumn Caption="Vertragsdauer:" FieldName="Duration" Name="Duration" />
                                    </Columns>
                                </dx:ASPxComboBox>
                        ...
                        <section class="bttmSecRightControls">
                            ...
                            <section class="secMemo">
                                <section class="secMemoHeader">
                                    <asp:Label ID="Label42" runat="server" Text="<%$ Resources:localizedText ,memo%>" CssClass="lblstandortheader" />
                                </section>
	...
	setSaveChanges();
                            ...
                            <section class="photo">
                                ...
                                <fieldset id="PhotoFieldset" class="fieldset">
                                    ...
                                    <div id="Photoholder" class="PhotoholderCls">
                                        ...
                                        <img id="img" runat="server" src=""  /><%--style="width: 100%; height: 100%"--%>
                                    </div>
                                </fieldset>
                            </section>
            ...
            <div id="middiv">
                ...
                <section class="accessreadergrp">
                    ...
                    <asp:Label ID="Label66" runat="server" Text="<%$ Resources:localizedText, accessviaccessgroup1 %>" CssClass="lblnewgridtitle"></asp:Label>
                    <section class="accessreadgrid">

                        <dx:ASPxGridView ID="grdAccessGroups" ClientInstanceName="grdAccessGroups" runat="server" AutoGenerateColumns="False" Width="68%"
	...
	AccessGroupFocused(s, e);
                ...
                <section class="tableSec">
                    <asp:Table runat="server" CellPadding="0" ID="accountOverviewTable" CellSpacing="0" CssClass="mainTable">
                        ...
                        <asp:TableRow CssClass="tblRow">
                            <asp:TableCell CssClass="tblCellColmnOne">
                                <asp:Label ID="Label79" runat="server" Text="Anwesende Stunden:" CssClass="lblTableHeader"></asp:Label>
                            </asp:TableCell>
...
grdSearchMemberRowDbClick(s,e);
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, studiogrpno%>" VisibleIndex="1" FieldName="GroupNumber">
                            <CellStyle HorizontalAlign="Left"></CellStyle>
                        </dx:GridViewDataTextColumn>
