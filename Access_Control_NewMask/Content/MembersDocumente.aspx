<%@ Page Title="Mitgliederstamm Dokumente" Language="C#" MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="MembersDocumente.aspx.cs" Inherits="Access_Control_NewMask.Content.MembersDocumente" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/MembersDocumente.js"></script>
    <link href="Styles/MembersDocumente.css" rel="stylesheet" />
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    ...
    <section class="leftinfo1">
        <asp:Button ID="btnNew" ClientIDMode="Static" CssClass="BottomFooterBtnsLeft newbtnfooterblue" runat="server" Text="<%$ Resources:localizedText, newidentitycard %>" Style="width: 139px; text-align: right !important; display:none !important;" />
        <asp:Button ID="btnEntSave" CssClass="BottomFooterBtnsLeft savebtnfootergreen" runat="server" Text="<%$ Resources:localizedText, saveidentitycard %>" Style="width: 219px; margin-left: 0; " />
        <asp:Button ID="btnCancelDel" ClientIDMode="Static" CssClass="BottomFooterBtnsLeft deletebtnfooterred" runat="server" Text="" Style="display:none !important; text-align: right !important; width: 217px" />
