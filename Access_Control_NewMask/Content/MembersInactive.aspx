<%@ Page Title="<%$ Resources:localizedText, memberinactive2 %>" Language="C#" MasterPageFile="~/MasterPages/Secondary.Master" AutoEventWireup="true" CodeBehind="MembersInactive.aspx.cs" Inherits="Access_Control_NewMask.Content.MembersInactive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="Styles/MembersInactive.css?v=<%= Access_Control_NewMask.Controllers.Version.JSVersion %>" rel="stylesheet" />
    <script src="Scripts/MembersInactive.js?v=<%= Access_Control_NewMask.Controllers.Version.JSVersion %>"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <div id="importantInfoDialogCustom" class="dialogBoxCustom"></div>
    ...
    <div id="ControlSection1" class="ControlSection">
        <div id="AEHeaderLeftDiv">
            <div id="BottomHeaderLabels">
                <asp:Label ID="Label45" runat="server" Text="<%$ Resources:localizedText, studiogroupnonew %>" CssClass="L1HeaderT1drplablesmandant"></asp:Label>
...
//dplGroupClick(s,e);	
                ...
                <asp:Label ID="Label50" runat="server" Text="<%$ Resources:localizedText, groupdescriptionnew %>" CssClass="L1HeaderT1drplables2"></asp:Label>
...
//cobMemberNrEndCallBack(s,e)	;
                ...
                <dx:ASPxComboBox ID="cobMemberName"
                    ...
                    OnCallback="cobMemberName_Callback" CallbackPageSize="100000">
                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
...
//dpMemberClick(s,e);	
	...
	//cobMemberNameEndCallBack(s,e);
        ...
        <div class="textsearcharea">
            ...
            <asp:UpdatePanel ID="upPnl_MemberNameSearch" runat="server">
                <ContentTemplate>
                    <dx:ASPxComboBox ID="cboMemberNameSearch" ClientInstanceName="cboMemberNameSearch" runat="server" EnableCallbackMode="True" ValueField="ID" ValueType="System.String" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif"
                        Font-Size="14px" CssClass="drpmemberstext ColorBlue" Theme="Office2003Blue" IncrementalFilteringMode="Contains"
                        OnItemsRequestedByFilterCondition="cboMemberNameSearch_OnItemsRequestedByFilterCondition" OnItemRequestedByValue="cboMemberNameSearch_OnItemRequestedByValue" TextFormatString="{0} {1}"
                        DropDownStyle="DropDown" DropDownRows="20" DropDownWidth="500px" CallbackPageSize="20">
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cboMemberNameSearchSelectionChanged(s,e);
}"></ClientSideEvents>
                        <Columns>
                            <dx:ListBoxColumn FieldName="MemberNumber" Caption="Nr.:" Name="MemberNumber" Width="20%" />
    ...
    <div id="ControlSection2">
        <div id="rightdiv1">
            <section class="upperSectionPersonal">
                <asp:Button ID="btnMembers" CssClass="newstandardbutton BottomFooterBtnsLeftdocument btnDocumente" runat="server" Text="<%$ Resources:localizedText, members %>" Style="padding-left: 13px !important; text-align: left !important; cursor: default;" />
                <asp:Button ID="btnMemberForm" CssClass="newstandardbutton BottomFooterBtnsLeftbogen btnbogen" runat="server" Text="<%$ Resources:localizedText, applicationForm %>" Style="padding-left: 0px !important; width: 77px; text-align: left !important;" OnClick="btnMemberForm_Click" />
                <asp:Button ID="btnMemberDocs" CssClass="newstandardbutton BottomFooterBtnsLeftdocument btnDocumente" runat="server" Text="<%$ Resources:localizedText, document %>" Style="padding-left: 13px !important; text-align: left !important; width: 102px !important; cursor: pointer !important;" OnClick="btnMemberDocs_Click" />
	...
	cobMemberGroupSelectedIndexChanged(s,e);
}" />
                                <Columns>
                                    <dx:ListBoxColumn Caption="Studio-Gruppen Nr:" Name="GroupNr" FieldName="GroupNr" Width="10%" />
                                    <dx:ListBoxColumn Caption="<%$ Resources:localizedText, groupdescriptionnew %>" Name="GroupName" FieldName="GroupName" Width="90%" />
                                </Columns>
                            </dx:ASPxComboBox>
                            <asp:Button ID="btnCompany" runat="server" Enabled="false" Text="" CssClass="btnpersonalsplit ColorRed fontweight600" ClientIDMode="Static" Style="margin-top: 1px;" />
                        </section>
                        ...
                        <section class="bttmSecLeftControls">
                            ...
                            <section class="secUserInput">
                                ...
                                <dx:ASPxComboBox ID="cobSalutation" ClientInstanceName="cobSalutation" runat="server" ValueField="AnredeCode" TextField="AnredeName" CssClass="dplpersonalsplit2 ColorBlue" Theme="Office2003Blue">
                                    ...
                                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
cobSalutationSelectedChanged(s,e);	
}"></ClientSideEvents>
                                </dx:ASPxComboBox>
                            </section>
                            <section class="secUserInput">
                                <asp:Label ID="Label13" runat="server" Text="<%$ Resources:localizedText ,membersnonew%>" CssClass="lblpersonalsplit"></asp:Label>
                                <asp:TextBox ID="txtMemberNr" ClientIDMode="Static" runat="server" Enabled="true" CssClass="txtpersonalsplit numbersOnly" Style="text-align: left !important; width: 90px;"></asp:TextBox>
                            ...
                            <section class="secUserInput">
                                <asp:Label ID="Label70" runat="server" Text="<%$ Resources:localizedText, no2 %>" CssClass="lblpersonal2 fontweight600"></asp:Label>
                            ...
                            <section class="secUserInput">
                                <asp:Label ID="Label56" runat="server" Text="<%$ Resources:localizedText, contractNo1 %>" CssClass="lblpersonal2 fontweight600"></asp:Label>
                            ...
                            <section class="secUserInput">
                                ...
                                <dx:ASPxComboBox runat="server" ID="cobDuration" ClientInstanceName="cobDuration" ValueField="ID" TextField="Duration" EnableCallbackMode="true" DropDownRows="6" DropDownWidth="240px" Theme="Office2003Blue" TextFormatString="{1}" CssClass="dplpersonalsplit">
                                    <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cobDurationSelectedChanged(s,e);
}"></ClientSideEvents>
                                    <Columns>
                                ...
                                <asp:Button ID="btnContractDuration" runat="server" Enabled="false" Text="..." CssClass="btnpersonalsplit ColorRed fontweight600" />

                            </section>
                            <section class="secUserInput">
                                <asp:Label ID="Label75" runat="server" Text="<%$ Resources:localizedText, membactive %>" CssClass="lblpersonal2 fontweight600" Style="min-width: 145px;"></asp:Label>
                        ...
                        <section class="bttmSecRightControls">
                            <section class="secSelectionTop">
                                ...
                                <section class="secSelection">
                                    <asp:Label ID="Label18" runat="server" Text="<%$ Resources:localizedText, mobile %>" CssClass="lblstandort"></asp:Label>

                                    <asp:TextBox ID="txtMobileNo" runat="server" CssClass="txtstandort"></asp:TextBox>
                                </section>
                                <section class="secSelection">
                                    <asp:Label ID="Label19" runat="server" Text="Email:" CssClass="lblstandort"></asp:Label>
                    ...
                    <section class="sectionAccessData">
                        ...
                        <section class="sec1">
                            <section class="sec1Divns">
                                <asp:Label ID="Label51" runat="server" Text="<%$ Resources:localizedText ,longTermCard1%>" CssClass="lblAccsssData fontweight600"></asp:Label>
                            </section>
                        ...
                        <section class="sec1">
                            <section class="sec1Divns">
                                <asp:Label ID="Label53" runat="server" Text="<%$ Resources:localizedText ,shortTimeCard1%>" CssClass="lblAccsssData fontweight600"></asp:Label>
                            </section>
                            <section class="sec1Divns2">
...
dpExitDateDateChanged(s,e);	
                        ...
                        <section class="sectitlearea">
                            <asp:Label ID="Label28" runat="server" Text="<%$ Resources:localizedText ,accessviaaccessplans %>" CssClass="lblDatetitle"></asp:Label>
                        </section>
	...
	setSaveChanges();
                    ...
                    <section class="webCamMode" style="display: none;">
                        ...
                        <section class="acceptButtons">
                            <asp:Button ID="btnTakePhoto" runat="server" Text="<%$ Resources:localizedText, takePhoto %>" CssClass="cameraButtonsLeft " Style="width: 109px;" />
            ...
            <div id="middiv">
                ...
                <section class="accessreadergrp">
                    ...
                    <asp:Label ID="Label66" runat="server" Text=" <%$ Resources:localizedText, accessviaccessgroup %>" CssClass="lblnewgridtitle"></asp:Label>
                    <section class="accessreadgrid">
                        <dx:ASPxGridView ID="grdAccessGroups" ClientInstanceName="grdAccessGroups" runat="server" Width="67%"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, description_new %>" VisibleIndex="2" Width="20%" HeaderStyle-BackColor="#ffffff" HeaderStyle-ForeColor="#000000">
                                    <HeaderStyle HorizontalAlign="left" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, active %>" VisibleIndex="3" Width="5%" HeaderStyle-BackColor="#ffffff" HeaderStyle-ForeColor="#000000">
                                    <HeaderStyle HorizontalAlign="center" />
                                ...
                                <dx:GridViewDataTextColumn Caption="Info:" VisibleIndex="6" Width="5%" HeaderStyle-BackColor="#ffffff" HeaderStyle-ForeColor="#000000">
                                    <HeaderStyle HorizontalAlign="center" />
                                    <CellStyle HorizontalAlign="Center"></CellStyle>
                                </dx:GridViewDataTextColumn>
                            </Columns>
                ...
                <asp:Label ID="Label5" runat="server" Text="<%$ Resources:localizedText, attendancehours %>" CssClass="lblnewbottomtitle"></asp:Label>
                <section style="width: 250px; height: 33px; float: left; clear: none; margin-left: 26.5%; margin-right: auto;">
	...
	SetActive(s, e, true);
                        ...
                        <dx:GridViewDataHyperLinkColumn FieldName="ExtendedTo" Width="10%" Caption="<%$ Resources:localizedText ,extended %>" VisibleIndex="6">
                            ...
                            <EditItemTemplate>
                                <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" NavigateUrl="#" Text='<%# (DateTime?)Eval("[ExtendedTo]") == null? 
                                        ". . ." : ((DateTime)Eval("[ExtendedTo]")).ToString("dd.MM.yyyy") %>'
                                    ForeColor="#0094FF" CssClass="lnkTransponders">
                                    <ClientSideEvents Click="function(s,e) {
                                            ShowEndingDates(s, e);
...
grdTransShortTermEndCallBack(s,e);
	...
	grdvwgrdClientsRowClick(s, e)
        ...
        <div id="gridSearch" class="searchContact" style="display: none;">
            <section class="searchContactgrid1">
...
grdSearchMemberRowDbClick(s,e);	
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, studiogroupnonew %>" VisibleIndex="1" FieldName="GroupNumber">
                            <CellStyle HorizontalAlign="Left"></CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText, groupdescriptionnew %>" VisibleIndex="2" FieldName="GroupName">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText ,membersno%>" VisibleIndex="3" FieldName="MemberNumber">
                            <CellStyle HorizontalAlign="Left"></CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="<%$ Resources:localizedText ,membername%>" VisibleIndex="4" FieldName="FullName">
                        </dx:GridViewDataTextColumn>
                    </Columns>
                    <SettingsBehavior AllowFocusedRow="True" AllowSelectByRowClick="True" AllowSelectSingleRowOnly="True" AllowSort="false" AllowDragDrop="false"></SettingsBehavior>
            ...
            <section class="btnApplySec">
                <asp:Button ID="btnApplyMember" runat="server" Text="<%$ Resources:localizedText, takeover %>" CssClass="ubernahme" />
            </section>
        </div>
    </div>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    <asp:Button ID="btnNew" CssClass="newbtnfooterblue" runat="server" Text="<%$ Resources:localizedText, newMember %>" Style="display: none !important;" />
    <asp:Button ID="btnActivateMember" CssClass="savebtnfootergreen" runat="server" Text="<%$ Resources:localizedText, enableMember%>" />
    <asp:Button ID="btnDelete" CssClass="deletebtnfooterred" runat="server" Text="<%$ Resources:localizedText, deleteMember%>" Style="display: none !important;" />
    ...
    <asp:Button ID="btnSaveAusweis" runat="server" Text="<%$ Resources:localizedText, saveCard %>" CssClass="btnAuswesSave" Style="padding-left: 2px; display: none !important;" />
    <asp:Button ID="btnDeleteAusweis" runat="server" Text="<%$ Resources:localizedText, deleteCard %>" CssClass="btnAuswesDelete" Style="display: none !important;" />
</asp:Content>

<asp:Content ID="Content5" ContentPlaceHolderID="FooterRight" runat="server">
    <asp:Button ID="btnBackToSettings" CssClass="backbtnfooterred" runat="server" Text="<%$ Resources:localizedText, backButton %>" />
