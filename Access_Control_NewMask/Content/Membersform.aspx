<%@ Page Title="<%$ Resources:localizedText, applicationForm %>" Language="C#" MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="Membersform.aspx.cs" Inherits="Access_Control_NewMask.Content.Membersform" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/Membersform.js"></script>
    <link href="Styles/Membersform.css" rel="stylesheet" />
...
dplGroupClick(s,e);	
                    ...
                    <Columns>
                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, studiogrpno %>" Name="GroupNumber" FieldName="GroupNumber" Width="10%" />
...
cobMemberNrEndCallBack(s,e)	;
                    ...
                    <Columns>
                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, membersno %>" Name="MemberNumber" FieldName="MemberNumber" Width="10%" />
                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, membername %>" Name="FullName" FieldName="FullName" Width="90%" />
                    </Columns>
                </dx:ASPxComboBox>
...
dpMemberClick(s,e);	
    ...
    <section id="uppersec" class="upperSectionPersonal">
        <asp:Button ID="btnPersonalStamm" CssClass=" newstandardbutton BottomFooterBtnsLeftdocument btnpersonal " runat="server" Text="<%$ Resources:localizedText, members %>"  />
        ...
        <div id="tabcontroldiv" class="tabcontroldiv">
            <asp:Label ID="Label2" runat="server" Text="<%$ Resources:localizedText, additionalFields %>" CssClass="lbladdfield"></asp:Label>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
        <asp:Button ID="btnNew" CssClass="newbtnfooterblue" runat="server" Text="<%$ Resources:localizedText, newButton %>" Style="display:none !important; width:46px;" />
    <asp:Button ID="btnSave" CssClass="savebtnfootergreen" runat="server" Text="<%$ Resources:localizedText, savedatanew %>" Style="width:102px; padding-left:2px;"/>
    <asp:Button ID="btnDelete" CssClass="deletebtnfooterred" runat="server" Text="Daten löschen" Style="width:103px; display:none !important;" />
