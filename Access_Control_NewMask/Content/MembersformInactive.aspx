<%@ Page Title="<%$ Resources:localizedText, inactivemembersmoreinfo %>" Language="C#" MasterPageFile="~/MasterPages/Secondary.Master" AutoEventWireup="true" CodeBehind="MembersformInactive.aspx.cs" Inherits="Access_Control_NewMask.Content.MembersformInactive" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/MembersformInactive.js"></script>
    <link href="Styles/MembersformInactive.css" rel="stylesheet" />
...
//dplGroupClick(s,e);	
                    ...
                    <Columns>
                        <dx:ListBoxColumn Caption="<%$ Resources:localizedText, studiogroupnonew %>" Name="GroupNumber" FieldName="GroupNumber" Width="10%" />
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    ...
    <asp:Button ID="btnSave" CssClass="savebtnfootergreen" runat="server" Text="Daten speichern" Style="width: 102px; padding-left: 2px;display: none; " />
