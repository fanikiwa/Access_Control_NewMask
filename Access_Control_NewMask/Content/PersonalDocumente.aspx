<%@ Page Title="Personalstamm Dokumente" Language="C#" MasterPageFile="~/MasterPages/Primary.Master" AutoEventWireup="true" CodeBehind="PersonalDocumente.aspx.cs" Inherits="Access_Control_NewMask.Content.PersonalDocumente" %>

<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="Styles/PersonalDocumente.css" rel="stylesheet" />
    <script src="Scripts/PersonalDocumente.js"></script>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    ...
    <section class="leftinfo1">
        <asp:Button ID="btnNew" CssClass="BottomFooterBtnsLeft newbtnfooterblue" runat="server" Text="<%$ Resources:localizedText, newidentitycard %>" Style="width: 139px; margin-left: 0px; display:none !important;" OnClick="btnEntSave_Click" />
        <asp:Button ID="btnEntSave" CssClass="BottomFooterBtnsLeft savebtnfootergreen" runat="server" Text="<%$ Resources:localizedText, saveidentitycard %>" Style="width: 186px; margin-left: 0px; " OnClick="btnEntSave_Click" />
        <asp:Button ID="btnCancelDel" ClientIDMode="Static" CssClass="BottomFooterBtnsLeft deletebtnfooterred" runat="server" Text="" Style="width: 174px; display:none !important;" OnClick="btnCancelDel_Click"  />
