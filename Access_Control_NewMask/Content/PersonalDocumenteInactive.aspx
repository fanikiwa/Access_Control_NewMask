<%@ Page Title="<%$ Resources:localizedText, personnelinactivemasterdocuments %>" Language="C#" MasterPageFile="~/MasterPages/Secondary.Master" AutoEventWireup="true" CodeBehind="PersonalDocumenteInactive.aspx.cs" Inherits="Access_Control_NewMask.Content.PersonalDocumenteInactive" %>


<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="Styles/PersonalDocumenteInactive.css" rel="stylesheet" />
    <script src="Scripts/PersonalDocumenteInactive.js"></script>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <asp:HiddenField ID="hiddenFieldRedirectAfterSave" runat="server" />
    ...
    <div class="contentarea2">
        <div class="perscenter">
            ...
            <div class="holder1">
                ...
                <section class="txtcontent">
                    <asp:TextBox ID="txtIDSize" runat="server" CssClass="txtarea1 ListenForChange"></asp:TextBox>
                </section>
            </div>
            <div class="holder1">
                <section class="lblarea">
     ...
     <section class="txtcontent"><asp:TextBox ID="TextBox27" runat="server" CssClass="txtarea1 ListenForChange" ></asp:TextBox></section>
    </div>
             <div class="holder1">
     ...
     <section class="txtcontent"><asp:TextBox ID="TextBox28" runat="server" CssClass="txtarea1 ListenForChange"  TextMode="MultiLine" Style="height:35px; overflow:hidden; resize:none;"></asp:TextBox></section>
    </div>--%>
            <div class="holder1">
                <section class="lblarea">
                    <asp:Label runat="server" Text="<%$ Resources:localizedText, isseudby%>" class="lblname1"></asp:Label>
        ...
        <div class="perscenterges" style="display: none">
            ...
            <div class="holder1">
                ...
                <section class="txtcontent">
                    <asp:TextBox ID="txtHIPersonalNumber" runat="server" CssClass="txtarea1 ListenForChange"></asp:TextBox>
                </section>
            </div>
            <div class="holder1">
                <section class="lblarea">
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    <%--<asp:Button ID="btnEntNew" CssClass="BottomFooterBtnsLeft btnNew" runat="server" Text="<%$ Resources:localizedText, newButton %>"   /> --%>
    <section class="leftinfo1">
        <asp:Button ID="btnNew" CssClass="BottomFooterBtnsLeft newbtnfooterblue" runat="server" Text="Personalausweis neu" Style="width: 139px; margin-left: 0px; display: none;" OnClick="btnEntSave_Click" />
        <asp:Button ID="btnEntSave" CssClass="BottomFooterBtnsLeft savebtnfootergreen" runat="server" Text="Personalausweis speichern" Style="width: 186px; margin-left: 0px; display: none;" OnClick="btnEntSave_Click" />
        <asp:Button ID="btnCancelDel" ClientIDMode="Static" CssClass="BottomFooterBtnsLeft deletebtnfooterred" runat="server" Text="" Style="width: 174px; display: none;" OnClick="btnCancelDel_Click" />

        <%--<asp:Button ID="btnCancelDel" CssClass="BottomFooterBtnsLeft btnLöschen" runat="server" Text="<%$ Resources:localizedText, deleteButton %>" />--%>
    </section>
