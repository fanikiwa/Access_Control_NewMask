<%@ Page Title="<%$ Resources:localizedText, inactivepersonnelmoreinfo %>" Language="C#" MasterPageFile="~/MasterPages/Secondary.Master" AutoEventWireup="true" CodeBehind="PersonalFormInactive.aspx.cs" Inherits="Access_Control_NewMask.Content.PersonalFormInactive" %>


<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/PersonalFormInactive.js"></script>
    <link href="Styles/PersonalFormInactive.css" rel="stylesheet" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHolder" runat="server">
        ...
        <div id="AEHeaderLeftDiv">
            ...
            <div id="BottomHeaderLists">
                ...
                <dx:ASPxComboBox ID="dplClients" runat="server" ValueField="ID" TextField="Client_Nr" ClientIDMode="Static"
                    TextFormatString="{0}-{1}" CssClass="L1HeaderT1drplists2client ColorBlue"  DropDownRows="20" DropDownWidth="400px" Theme="Office2003Blue">
	...
	dplClientsNameSelectedIndexChanged(s,e);
                ...
                <dx:ASPxComboBox ID="dpllLocation" runat="server" ValueField="ID" TextField="Name" ClientIDMode="Static"
                    TextFormatString="{2}" CssClass="L1HeaderT1drplists2 ColorBlue" DropDownRows="20" DropDownWidth="400px" Theme="Office2003Blue">
	...
	dplDepartmentSelectedIndexChanged(s, e);
                ...
                <dx:ASPxComboBox ID="dpllPersName" runat="server" ValueField="Pers_Nr" ValueType="System.Int32" TextField="PersNr_Fullname" ClientIDMode="Static" DropDownRows="20" EnableCallbackMode="True" OnCallback="dpllPersName_Callback"
                ...
                <dx:ASPxComboBox ID="dplIDNr" runat="server" ValueField="Pers_Nr" ValueType="System.Int32" TextField="Pers_Nr" ClientIDMode="Static" DropDownRows="20"
                    TextFormatString="{0}" CssClass="L1HeaderT1drplists2new ColorBlue" DropDownWidth="100px" Theme="Office2003Blue" HorizontalAlign="left" EnableCallbackMode="True" OnCallback="dplIDNr_Callback">
                ...
                <dx:ASPxComboBox ID="dplAusweisNr" runat="server" ValueField="Pers_Nr" ValueType="System.Int32" TextField="Card_Nr_Str" ClientIDMode="Static" DropDownRows="20"
                    TextFormatString="{0}" CssClass="L1HeaderT1drplists2new ColorBlue" DropDownWidth="100px" Theme="Office2003Blue" HorizontalAlign="left" EnableCallbackMode="True" OnCallback="dplAusweisNr_Callback">

                    <ClientSideEvents SelectedIndexChanged="function(s, e) { dplAusweisNrPersNameSelectedIndexChanged(s, e); }"></ClientSideEvents>
                    <Columns>
                        <dx:ListBoxColumn FieldName="Pers_Nr" Name="ProfileDescription" ToolTip="" Width="10%" Caption="<%$ Resources:localizedText, cardNo %>" />
                        <dx:ListBoxColumn FieldName="IdentificationNr_string" Name="ID" ToolTip="Bezeichnung:" Width="90%" Visible="false" />
                    </Columns>
                </dx:ASPxComboBox>
            </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    ...
    <asp:Button ID="btnSave" CssClass="BottomFooterBtnsLeft savebtnfootergreen" runat="server" Text="<%$ Resources:localizedText, savedatanew %>" Style="width: 105px; display: none;" />
    <asp:Button ID="btnDelete" CssClass="BottomFooterBtnsLeft deletebtnfooterred" runat="server" Text="<%$ Resources:localizedText, deletedatedatanew %>" Style="width: 110px; display: none;" />
</asp:Content>
