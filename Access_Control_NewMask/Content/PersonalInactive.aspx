<%@ Page Title="<%$ Resources:localizedText, personelinavctive %>" ClientIDMode="Static" Language="C#" MasterPageFile="~/MasterPages/Secondary.Master" AutoEventWireup="true" CodeBehind="PersonalInactive.aspx.cs" Inherits="Access_Control_NewMask.Content.PersonalInactive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="Styles/PersonalInactive.css?v=<%= Access_Control_NewMask.Controllers.Version.JSVersion %>" rel="stylesheet" />
    <script src="Scripts/PersonalInactive.js?v=<%= Access_Control_NewMask.Controllers.Version.JSVersion %>"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <div id="ImportantDialogBox" class="dialogBox"></div>
            ...
            <div id="AEHeaderLeftDiv">
                ...
                <div id="BottomHeaderLists">
                    ...
                    <dx:ASPxComboBox ID="cmbClients" runat="server" ValueField="ID" TextField="Client_Nr" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
                        TextFormatString="{0}" CssClass="lblMandant ColorBlue" DropDownRows="20" DropDownWidth="400px" Theme="Office2003Blue" AutoPostBack="false">
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cmbClientsSelectedIndexChanged(s, e);
}" />
                        <Columns>
                    ...
                    <dx:ASPxComboBox ID="cmbClientsName" ClientIDMode="Static" runat="server" ValueField="ID" TextField="Client_Nr" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
                        ...
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cmbClientsNameSelectedIndexChanged(s, e);
}" />
                        <Columns>
                    ...
                    <dx:ASPxComboBox ID="cmbLocation" runat="server" ValueField="ID" TextField="Name" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
                        ...
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cmbLocationNameSelectedIndexChanged(s, e);
}" />
                        <Columns>
                    ...
                    <dx:ASPxComboBox ID="cmbDepartment" runat="server" ValueField="ID" TextField="Name" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="14px"
                        TextFormatString="{1}" CssClass="L1HeaderT1drplists ColorBlue" DropDownRows="20" DropDownWidth="400px" Theme="Office2003Blue">
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cmbDepartmentSelectedIndexChanged(s, e);
}" />
                        <Columns>
                    ...
                    <dx:ASPxComboBox ID="cmbPersName" runat="server" ClientInstanceName="cmbPersName" ValueType="System.Int32" ClientIDMode="Static" ValueField="Pers_Nr" EnableCallbackMode="True" OnCallback="cmbPersName_Callback"
                        ...
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cmbPersNameSelectedIndexChanged(s, e);
}"
	...
	//GetLastPersNr();
                    ...
                    <dx:ASPxComboBox ID="cmbIDNr" HorizontalAlign="left" runat="server" ClientInstanceName="cmbIDNr" ClientIDMode="Static" ValueField="Pers_Nr" TextField="Pers_Nr" EnableCallbackMode="true" AutoPostBack="false"
                        ...
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cmbIDNrSelectedIndexChanged(s, e);
}"
                            BeginCallback="function(s, e) {
	//GetLastPersNr(s);
}"
	...
	//SetLastPersNr(s);
                    ...
                    <dx:ASPxComboBox ID="cmbAusweisNr" HorizontalAlign="left" runat="server" ValueField="Pers_Nr" ClientInstanceName="cmbAusweisNr" ClientIDMode="Static" TextField="Card_Nr_Str" EnableCallbackMode="true" AutoPostBack="false"
                        ...
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	cmbAusweisNrSelectedIndexChanged(s, e);
}"
                            BeginCallback="function(s, e) {
	//GetLastPersNr(s);
}"
	   ...
	   // InitialPageLoadPanel.Hide();
            ...
            <div class="textsearcharea">
                ...
                <asp:UpdatePanel ID="upPnl_MemberNameSearch" runat="server">
                    <ContentTemplate>
                        <dx:ASPxComboBox ID="cboPersonNameSearch" ClientInstanceName="cboPersonNameSearch" runat="server" EnableCallbackMode="True" ValueField="Pers_Nr" ValueType="System.String" Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif"
                        ...
                        <section class="topHeaderSec">
                            <section class="headerLeftSec">
                                ...
                                <dx:ASPxComboBox ID="dplCompanyName" runat="server" ValueField="ID" TextField="Client_Nr"
                                    TextFormatString="{0}-{1}" CssClass="dplpersonalsplit2 ColorBlue" DropDownRows="20" DropDownWidth="400px" Theme="Office2003Blue">
	...
	dplCompanyNameSelectedIndexChanged(s,e);
                                ...
                                <asp:Button ID="btnCompany" Enabled="false" runat="server" Text="" CssClass="btnpersonalsplit ColorRed fontweight600" ClientIDMode="Static" Style="margin-top: 1px;" />
                            </section>
                        ...
                        <section class="bttmSection">
                            <section class="bttmSecLeftControls">
                                ...
                                <section class="secUserInput">
                                    ...
                                    <asp:TextBox ID="txtPersonalNr" runat="server" Enabled="true" CssClass="txtpersonalsplit numbersOnly" Style="text-align: left !important; width: 90px;"></asp:TextBox>
                                </section>
                                <section class="secUserInput">
                                ...
                                <section class="secUserInput">
                                    ...
                                    <dx:ASPxComboBox runat="server" ID="ddlPersType" ClientInstanceName="ddlPersType" ValueField="ID" TextField="Name" EnableCallbackMode="true" DropDownRows="6"
                                        DropDownWidth="240px" Theme="Office2003Blue" TextFormatString="{0}" CssClass="dplpersonalsplit" OnCallback="ddlPersType_Callback">
	...
	//ddlPersTypeEndCallback(s,e);
                                    ...
                                    <asp:Button ID="btnPersType" Enabled="false" runat="server" Text="..." CssClass="btnpersonalsplit ColorRed fontweight600" />
                            ...
                            <section class="bttmSecRightControls">
                                ...
                                <section class="secSelectioncheck">
                                    <asp:Label ID="Label77" runat="server" Text="<%$ Resources:localizedText ,persactive%>" CssClass="lblpersonal2lbl fontweight600" Style="min-width: 100px;"></asp:Label>
                                    <asp:CheckBox ID="chkActivatePersonal" runat="server" CssClass="chkAccssDataarea" />
                                </section>
	...
	//setSaveChanges();
                ...
                <div id="middiv">
                    <div id="middivTitle">
                        ...
                        <asp:Label ID="Label15" CssClass="quickinfotitle" runat="server" Text="<%$ Resources:localizedText, accessviaccessgroup %>" />
                    </div>
...
//	setSaveChanges();
                        ...
                        <section class="accessreadergrp">
                            <dx:ASPxGridView ID="grdAccessGroups" ClientInstanceName="grdAccessGroups" runat="server" AutoGenerateColumns="False" Width="67%"
                                ...
                                Font-Names="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif" Font-Size="12px" KeyFieldName="ID" Theme="Office2003Blue">
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn VisibleIndex="0" Visible="false" FieldName="ID"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataComboBoxColumn Caption="<%$ Resources:localizedText, no2 %>" VisibleIndex="1" FieldName="GroupID"
   ...
   // AccessGroupIndexChanged(s, e);
	...
	//AccessGroupFocused(s, e);
                                                ...
                                                <Columns>
                                                    <dx:ListBoxColumn FieldName="AccessPlanGroupNr" Caption="<%$ Resources:localizedText, no2 %>" Name="Nr.:" ToolTip="Nr." Width="16%" />
   ...
   // AccessGroupIndexChanged(s, e);
	...
	//AccessGroupFocused(s, e);
                                    ...
                                    <dx:GridViewDataHyperLinkColumn Caption="<%$ Resources:localizedText, info %>" VisibleIndex="6" Width="4%" FieldName="GroupID" ReadOnly="true"
                                        ...
                                        <PropertiesHyperLinkEdit ImageHeight="18px" ImageUrl="~/Images/FormImages/infor-30px.png" ImageWidth="18px" Target="_top" NavigateUrlFormatString="" TextFormatString="">
	...
	ausweisChanged(s, e, 2);
                            ...
                            <dx:GridViewDataCheckColumn Caption="Aktiv:" VisibleIndex="3" Width="8%" FieldName="TransponderActive">
                                <PropertiesCheckEdit>
                                    <ClientSideEvents CheckedChanged="function(s, e) {
    if (s.GetChecked()) {
                ...
                <div class="Wrappernew">
                    <div id="Grid" class="Grid">
                        <dx:ASPxGridView ID="grdPersType" runat="server" CellPadding="4" ForeColor="#333333" Width="100%" GridLines="Both" Theme="Office2003Blue" OnCustomCallback="grdPersType_CustomCallback"
                            AutoGenerateColumns="False" KeyFieldName="ID" ClientInstanceName="grdPersType" font-family="Segoe UI,Tahoma,Arial,Geneva,Verdana,sans-serif !important" Font-Size="14px" SettingsPager-PageSize="14">
                            <ClientSideEvents RowClick="function(s, e) {
	...
	//grdPersTypeRowDbClick(s,e);
                    ...
                    <section class="ActionBtnsBottom">
                        ...
                        <asp:Button ID="btnPersTypeBack" CssClass="BottomFooterBtnsRight backbtnfooterred" runat="server" Text="<%$ Resources:localizedText, backButton %>" />
                    </section>
                </div>
            </div>
...
//grdClientsClientsRowDblClick(s, e)
                    ...
                    <section class="ActionBtnsBottom">
                        ...
                        <asp:Button ID="btnCompanyBack" CssClass="BottomFooterBtnsRight backbtnfooterred" runat="server" Text="<%$ Resources:localizedText, backButton %>" />
                    </section>
                </div>
            </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="FooterLeft" runat="server">
    ...
    <asp:Button ID="btnSaveAusweis" runat="server" Text="<%$ Resources:localizedText, saveCard %>" CssClass="btnAuswesSave" Style="display: none !important;" />
    ...
    <asp:Button ID="btnNew" CssClass="BottomFooterBtnsLeft newbtnfooterblue" runat="server" Text="<%$ Resources:localizedText, newPersonal %>" Style="visibility: hidden; display: none;" />
    <asp:Button ID="btnActivatePersonal" CssClass="BottomFooterBtnsLeft deletebtnfooterred" runat="server" Text="<%$ Resources:localizedText, enablepersonnel %>" />
    <asp:Button ID="btnDelete" CssClass="BottomFooterBtnsLeft deletebtnfooterred" runat="server" Text="<%$ Resources:localizedText, deletePersonal %>" Style="visibility: hidden;" />
</asp:Content>
