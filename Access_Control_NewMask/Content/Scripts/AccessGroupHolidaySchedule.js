...
function getLocalizedText(key) {
    ...
    $.ajax({
        type: "POST",
        async: false,
        url: "AccessGroupHolidaySchedule.aspx/GetLocalizedText",
...
$(function () {
    ...
    $("#btnReader").click(function (evt) {
        evt.preventDefault();
        var planId = $("#txtAccessGroupId").val();
...
function getSelectedAccessPLans(planId) {
    ...
    $.ajax({
        type: "POST",
        async: false,
        url: "AccessGroupHolidaySchedule.aspx/AccessProfileList",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(data),
        success: function (result) {
...
function saveHolidayCalendarBack() {
    ...
    var accessPlanGroupId = $("#txtAccessGroupId").val();
    ...
    PageMethods.SaveHolidaySchedule(planId, planNr, planName, memo, allowAccess, calendarId, accessPlanGroupId, SaveHolidayScheduleOnBack_CallBack);
}
...
function SaveHoliday_Schedule() {
    ...
    PageMethods.SaveHolidaySchedule(planId, planNr, planName, memo, allowAccess, calendarId, accessPlanGroupId, OnSaveHolidaySchedule_CallBack);
}
