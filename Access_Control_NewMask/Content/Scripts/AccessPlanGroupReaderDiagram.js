    ...
    var locationTemplate =
     $$(go.Node, "Horizontal",
            ...
            { defaultAlignment: go.Spot.Left },
               ...
               { row: 2, column: 0, margin: 2, stroke: "black", font: "12px sans-serif", width: 100, editable: true, name: "ButtonName", isMultiline: false },
               new go.Binding("text", "text").makeTwoWay()),
               //Address
                $$(go.TextBlock, " ",
               { row: 3, column: 0, margin: 2, stroke: "black", font: "12px sans-serif", width: 100, editable: true, name: "AddressName", isMultiline: false },
               new go.Binding("text", "Address").makeTwoWay()),
                //Street
                $$(go.TextBlock, " ",
               { row: 4, column: 0, margin: 2, stroke: "black", font: "12px sans-serif", width: 100, editable: true, name: "StreetName", isMultiline: false },
  ...
  $$(go.Node, "Horizontal",
   ...
   $$(go.Shape, { fill: "white", stroke: "black", strokeWidth: 1, height: 60, width: 50 }),
        ...
        $$(go.RowColumnDefinition,
          ...
          $$(go.Panel, "TableRow", { row: 1 },
            $$("CheckBoxPanel", "groupChoice", { column: 1, margin: 2 })
        )
        )
  ),
   //changes
    ...
    if (node !== null) {
        if (node.isSelected) {
            ...
            setTimeout((function (_key) {
                try {
                    console.log(PlanDiagram.findNodeForKey(_key).data);
                    var filterNode = PlanDiagram.findNodeForKey(_key).data;
                    grdBuildingPlanGrid.PerformCallback(filterNode.key + '#' + filterNode.level)
...
function cxcommandTerminalInfo() {
    ...
    if (objectLevel == 5) {
        ...
        $.ajax({
            type: "POST",
            async: false,
            url: "VisitorPlanReader.aspx/PassVariables",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify(data),
            success: function () {
...
function ActivateReaderStatus() {
    ...
    $.ajax({
        type: "POST",
        async: false,
        url: "VisitorPlanReader.aspx/ActivateDeactivateReaders",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(data),
        success: function () {
...
function CheckIfReaderAssigned(buildingPlanId, doorID) {
    ...
    $.ajax({
        type: "POST",
        async: false,
        url: "VisitorPlanReader.aspx/CheckIfReaderAssigned",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(data),
        success: function (result) {
...
function CheckIfReaderActive(buildingPlanId, doorID) {
    ...
    $.ajax({
        type: "POST",
        async: false,
        url: "VisitorPlanReader.aspx/CheckIfReaderActive",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(data),
        success: function (result) {
...
function ActivateDeactivateAccessProfile(ProfileActive) {
    ...
    var obj = diagram.toolManager.contextMenuTool.currentObject;
    var buildingPlanId = cobBuildingPlanLocation.GetValue();
    var visitorPlanNr = $("#txtVisitorProfileNumber").val();
    var doorID = selectedNodeKey;
    var active = ProfileActive;

    var data = { buildingPlanId: buildingPlanId, doorID: doorID, visitorPlanNr: visitorPlanNr, PlanActive: active };

    $.ajax({
        type: "POST",
        async: false,
        url: "VisitorPlanReader.aspx/ActivateDeactivateAccessProfile",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(data),
        success: function () {
...
function CheckIfAccessPlanActive(buildingPlanId, doorID, visitorPlanNr) {
    var data = { buildingPlanId: buildingPlanId, doorID: doorID, visitorPlanNr: visitorPlanNr };

    $.ajax({
        type: "POST",
        async: false,
        url: "VisitorPlanReader.aspx/CheckIfAccessPlanActive",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify(data),
        success: function (result) {
