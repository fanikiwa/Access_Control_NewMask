/// <reference path="../GateVisitors.aspx" />
...
$(function () {
    ...
    $('.chkToday').change(function (evt) {
        ...
        $(".chkToday").each(function (ev) {
            ...
            $("#lblDisplaySelection").text("  Heute");
            //DisReports();
        });
    ...
    $('.chkPreviousDay').change(function (evt) {
        ...
        $(".chkPreviousDay").each(function (ev) {
            ...
            $("#lblDisplaySelection").text("  Gestern");
    ...
    $('.chkThisWk').change(function (evt) {
        ...
        $(".chkThisWk").each(function (ev) {
            ...
            $("#lblDisplaySelection").text("Diese Woche");
        });
    });
    $('.chkLastWk').change(function (evt) {
        ...
        $(".chkLastWk").each(function (ev) {
            ...
            $("#lblDisplaySelection").text("Letze Woche");
    ...
    $('.chkThisMonth').change(function (evt) {
        ...
        $(".chkThisMonth").each(function (ev) {
            ...
            $("#lblDisplaySelection").text("Dieser Monat");
    ...
    $('.chkLastmonth').change(function (evt) {
        ...
        $(".chkLastmonth").each(function (ev) {
            ...
            $("#lblDisplaySelection").text("Letzer Monat");
        });
    });
    ...
    //
    $("#chkObjStudioGroup").change(function () {
        if ($("#chkObjStudioGroup")[0].checked == false) {
            $("#chkObjStudioGroup")[0].checked = true;
        }
    });

    $("#chkPersStudioGroup").change(function () {
        if ($("#chkPersStudioGroup")[0].checked == false) {
...
function DisReports() {
    ...
    $("#TxtDisplayFrom").val(TimeFrom.GetText());
...
function SetValues(value) {
    PageMethods.GetAccessVisitorReportbyid(value, ReloadDropDowns);
}
...
function clearcontrols() {
    ...
    $('#chkPersShortTermCard')[0].checked = true;
    $('#chkPersShortTermCard')[0].checked = true;
...
function savePersonalReport() {
    ...
    var printSelection = 0, date = 0, time = 0, location = 0, building = 0, level = 0, room = 0, door = 0, company = 0, persLocation = 0, persDept = 0, PersCC = 0, persName = 0, persCardnrLng = 0, persCardNrShort = 0, studioGroup = 0;
    ...
    if (id == 0) {
        ...
        perClientNameFrom, perClientNameTo, perPersonalFrom, perPersonalTo, perShortTrannspoderFrom, perShortTrannspoderTo, dateFrom, dateTo, printSelection, date, time, location, building, level, room, door, studioGroup, persName, persCardNrShort, timeFrom, timeTo, SetValuesNew);
    } else {
...
function grdReportRowClick(s, e) {
    ...
    PageMethods.GetAccessVisitorReportbyid(id, populatecontrolls);
}
...
function _sendReportSettingsToDocumentViewer() {
    ...
    if (($('#chkoject').is(':checked'))) {
        grdShoewReport.PerformCallback(jsonString);
    }
...
function getLocalizedText(key) {
    ...
    $.ajax({
        type: "POST",
        async: false,
        url: "VisitorReports.aspx/GetResourceText",
