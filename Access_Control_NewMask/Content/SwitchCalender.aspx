<%@ Page Title="<%$ Resources:localizedText, switchCalender %>" Language="C#" MasterPageFile="~/MasterPages/Secondary.Master" AutoEventWireup="true" CodeBehind="SwitchCalender.aspx.cs" Inherits="Access_Control_NewMask.Content.SwitchCalender" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/SwitchCalender.js"></script>
    <link href="Styles/SwitchCalender.css" rel="stylesheet" />
</asp:Content>
        ...
        <div class="ControlSection2bottom">
            <div class="Wrapperdivinfo">
                ...
                <section class="lblsoftware">
                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:localizedText, notincludedinthesolutionmustorderseparate %>"></asp:Label>
                </section>
