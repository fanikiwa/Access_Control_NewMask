...
{
    public class PersonalReportsListDto
    {
        ...
        public string AusweisNrShortTerm { get; set; }
        ...
        public string StreetNrAndName { get; set; }
        ...
        public string VariableTextType { get; set; }
         
        public string PersLocationFrom { get; set; }
        public string PersLocationTo { get; set; }

        public string PersDepartmentFrom { get; set; }
        public string PersDepartmentTo { get; set; }
