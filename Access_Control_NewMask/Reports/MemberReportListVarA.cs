...
/// <summary>
/// Summary description for MemberReportListVarA
/// </summary>
public class MemberReportListVarA : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public MemberReportListVarA()
    {
        InitializeComponent();
        this.DataSource = HttpContext.Current.Session["MembersListARpt"];
    ...
    private void InitializeComponent()
    {
            ...
            this.xrTableCell13.Text = "Studio Gruppe";
