...
{
    public class KrutecBaseRepository<T> where T : class
    {
        #region Constructor

        public KrutecBaseRepository() { }
        ...
        /*
         *internal to only classes deriving KruAllBaseRepository
         *this is mainly to aid in overriding any methods
         */
        internal KrutecPZE _contextPZE = new KrutecPZE(); 
