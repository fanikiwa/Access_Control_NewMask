...
{
    public class PersonnelInactiveRepository : KruAllBaseRepository<Personal>
    {
        #region Constructor
        public PersonnelInactiveRepository() { }
        ...
        {
            return base.GetAll().Where(i => i.Active == false).OrderBy(x => x.Pers_Nr).ToList();
        }
